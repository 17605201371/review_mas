...
- candidate: `mimo_v25_negqty_recoverycap_guard3_qhyg_targetneg_freeformrevneg_reviewissuebundle_hardneg20_mt7_b4w2_api2_r8t600_tok1536_20260629_223747.jsonl` (label: P28_1_FIX_RECOMPUTE_223747, papers: 20)
...
| metric | P28_1_FIX_RECOMPUTE_223747 |
|---|---|
...
| `reviewer_absence_verified_count` | 14 |
| `reviewer_absence_verified_claim_count` | 17 |
| `reviewer_absence_verified_flaw_count` | 14 |
...
| `verified_issue_without_recovery_count` | 9 |
...
| `review_issue_candidate_counterevidence_rejected` | 24 |
...
| `assessment_limitation_flaw_count` | 21 |
| `negative_grounding_conflict_count` | 10 |
| `invalid_negative_evidence_id_count_legacy` | 10 |
| `negative_semantic_anchor_conflict_count` | 10 |
...
| `contamination_evidence_misbinding` | 10 |
...
| code | P28_1_FIX_RECOMPUTE_223747 | interpreted safety outcome |
|---|---|---|
...
| decision | P28_1_FIX_RECOMPUTE_223747 |
|---|---|
| `reject` | 20 |
