...
- candidate: `mimo_v25_negqty_recoverycap_guard3_qhyg_targetneg_freeformrevneg_reviewissuebundle_hardneg20_mt7_b4w2_api2_r8t600_tok1536_20260629_223747.jsonl` (label: P28_2_MANUALAUDIT_RECOMPUTE_223747, papers: 20)
...
| metric | P28_2_MANUALAUDIT_RECOMPUTE_223747 |
|---|---|
...
| `negative_evidence_candidate_raw_count` | 8 |
| `review_negative_verified_count` | 1 |
| `reviewer_absence_verified_count` | 7 |
| `reviewer_absence_verified_claim_count` | 17 |
| `reviewer_absence_verified_flaw_count` | 7 |
| `total_review_negative_verified_count` | 8 |
| `quote_grounded_review_issue_count` | 1 |
| `obligation_grounded_review_issue_count` | 7 |
| `obligation_grounded_review_issue_claim_count` | 7 |
| `reviewer_candidate_review_issue_count` | 7 |
| `reviewer_candidate_review_issue_claim_count` | 7 |
| `claim_obligation_review_issue_count` | 0 |
| `claim_obligation_review_issue_claim_count` | 0 |
| `verified_review_issue_count` | 8 |
| `verified_review_issue_row_count` | 8 |
| `verified_review_issue_claim_count` | 8 |
| `review_issue_bundle_count` | 7 |
...
| `review_issue_type_missing_ablation` | 5 |
...
| `negative_evidence_linked_to_flaw_raw_count` | 8 |
...
| `assessment_limitation_flaw_count` | 29 |
| `negative_grounding_conflict_count` | 17 |
| `invalid_negative_evidence_id_count_legacy` | 17 |
| `negative_semantic_anchor_conflict_count` | 17 |
...
| `final_potential_concern_total` | 24 |
...
| metric | P28_2_MANUALAUDIT_RECOMPUTE_223747 |
|---|---|
| `state_contamination_count` | 27 |
| `state_contamination_count_legacy` | 27 |
| `harmful_state_contamination_count` | 0 |
| `repairable_state_warning_count` | 0 |
| `conservative_state_warning_count` | 27 |
| `state_hygiene_warning_count` | 27 |
| `weak_target_warning_count` | 27 |
| `repairable_contamination_target_count` | 0 |
| `conservative_contamination_target_count` | 27 |
...
| `contamination_evidence_misbinding` | 17 |
...
| `state_hygiene_open_gap_count` | 27 |
...
| `verified_issue_contested_repair` | 2 |
| `stale_absence_contested_repair` | 6 |
...
| `recovery_case_effective_repair_without_verified_negative` | 6 |
...
| `recovery_case_turns_with_verified_review_issue_bundle_evidence` | 2 |
| `recovery_case_turns_with_reviewer_absence_audit_evidence` | 0 |
| `recovery_case_evidence_bucket_verified_review_negative` | 1 |
| `recovery_case_evidence_bucket_obligation_grounded_review_issue` | 2 |
| `recovery_case_evidence_bucket_reviewer_absence_audit` | 0 |
| `recovery_case_evidence_bucket_stale_reviewer_absence_audit` | 7 |
...
| code | P28_2_MANUALAUDIT_RECOMPUTE_223747 | interpreted safety outcome |
|---|---|---|
...
| decision | P28_2_MANUALAUDIT_RECOMPUTE_223747 |
|---|---|
| `reject` | 20 |
