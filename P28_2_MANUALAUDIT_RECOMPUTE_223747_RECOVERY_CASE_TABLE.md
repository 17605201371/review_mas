...
| bucket::effective_repair_without_verified_negative | 6 |
...
| evidence_bucket::stale_reviewer_absence_audit | 7 |
...
| xUe1YqEgd6 | 4 | effective_repair_without_verified_negative | mark_contested | hygiene_delta_improved | claim:claim-2 | supported->supported | {"stale_reviewer_absence_audit": 1} |
...
| KOUAayk5Kx | 5 | effective_repair_without_verified_negative | mark_contested | hygiene_delta_improved | claim:claim-1 | supported->supported | {"stale_reviewer_absence_audit": 1} |
| KOUAayk5Kx | 6 | effective_repair_without_verified_negative | mark_contested | hygiene_delta_improved | claim:claim-2 | supported->supported | {"stale_reviewer_absence_audit": 1} |
| KOUAayk5Kx | 7 | effective_repair_without_verified_negative | mark_contested | hygiene_delta_improved | claim:claim-2 | supported->supported | {"stale_reviewer_absence_audit": 1} |
...
| KOUAayk5Kx | 5 | effective_repair_without_verified_negative | evidence-reviewer-absence-claim-1-ablation-or-component-mi | stale_reviewer_absence_audit | missing_ablation |  | claim-evidence coverage audit | Verified review issue bundle: the paper claim and observed inventory support a missing ablation concern; missing/mismatch item(s): component-isolation ablation for orthogonal direction to the gradient. Target claim: '... |
| KOUAayk5Kx | 6 | effective_repair_without_verified_negative | evidence-reviewer-absence-claim-2-ablation-or-component-mi | stale_reviewer_absence_audit | missing_ablation |  | claim-evidence coverage audit | Verified review issue bundle: the paper claim and observed inventory support a missing ablation concern; missing/mismatch item(s): component-isolation ablation for orthogonal gradient. Target claim: 'OGL is applied to... |
| KOUAayk5Kx | 7 | effective_repair_without_verified_negative | evidence-reviewer-absence-claim-2-ablation-or-component-mi | stale_reviewer_absence_audit | missing_ablation |  | claim-evidence coverage audit | Verified review issue bundle: the paper claim and observed inventory support a missing ablation concern; missing/mismatch item(s): component-isolation ablation for orthogonal gradient. Target claim: 'OGL is applied to... |
