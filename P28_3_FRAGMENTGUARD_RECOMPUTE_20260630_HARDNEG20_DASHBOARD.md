...
- candidate: `P28_3_PROMPTDISC_COMBINED_20260630_013639_104423_HARDNEG20.jsonl` (label: P28_3_FRAGMENTGUARD_RECOMPUTE, papers: 20)
...
| metric | P28_3_FRAGMENTGUARD_RECOMPUTE |
|---|---|
...
| `obligation_grounded_review_issue_cluster_count` | 6 |
...
| `verified_issue_without_recovery_count` | 6 |
...
| `verified_negative_flaw_count` | 11 |
...
| `verified_potential_concern_count` | 11 |
...
| metric | P28_3_FRAGMENTGUARD_RECOMPUTE |
|---|---|
| `contested_support_total` | 23 |
| `contested_final_support_total` | 9 |
...
| code | P28_3_FRAGMENTGUARD_RECOMPUTE | interpreted safety outcome |
|---|---|---|
...
| decision | P28_3_FRAGMENTGUARD_RECOMPUTE |
|---|---|
| `reject` | 20 |
