...
- candidate: `mimo_v25_negqty_recoverycap_guard3_qhyg_targetneg_freeformrevneg_reviewissuebundle_hardneg20_mt7_b4w2_api2_r8t600_tok1536_20260630_194911.jsonl` (label: P28_6_CONFLICTFIX_TARGETREFINE2_194911, papers: 20)
...
| `real_strong_support_total` | `>=` | 16 | smoke scaled from 30/39 | 56 | PASS |
...
| metric | P28_6_CONFLICTFIX_TARGETREFINE2_194911 |
|---|---|
| `evidence_agent_worker_turns` | 70 |
| `evidence_json_status_turns` | 63 |
| `evidence_json_valid_turns` | 63 |
...
| `evidence_json_raw_chars_median` | 1313 |
| `quote_bank_nonzero_turns` | 70 |
| `payload_evidence_item_total` | 109 |
| `evidence_agent_nonempty_payload_turns` | 46 |
...
| metric | P28_6_CONFLICTFIX_TARGETREFINE2_194911 |
|---|---|
| `real_strong_support_total` | 56 |
| `independent_support_group_total` | 54 |
| `diagnostic_independent_support_group_total` | 70 |
| `claims_with_2plus_independent_or_diagnostic_support` | 22 |
| `empirical_real_strong_support_count` | 42 |
| `method_real_strong_support_count` | 14 |
| `table_or_figure_real_strong_support_count` | 25 |
| `result_or_experiment_real_strong_support_count` | 13 |
...
| `moderate_absorbed_into_final_strong_count` | 31 |
...
| `claims_with_real_strong_support` | 39 |
| `claims_with_empirical_real_strong_support` | 30 |
...
| `primary_claims_with_empirical_support` | 28 |
| `primary_claims_with_deep_support` | 29 |
| `zero_real_papers` | 2 |
| `final_support_total` | 56 |
| `final_support_direct_strong_count` | 25 |
| `final_support_promoted_from_medium_count` | 31 |
...
| `support_trace_included_count` | 56 |
| `support_trace_dropped_count` | 58 |
...
| `negative_evidence_candidate_raw_count` | 13 |
| `review_negative_verified_count` | 0 |
| `reviewer_absence_verified_count` | 13 |
| `reviewer_absence_verified_claim_count` | 22 |
| `reviewer_absence_verified_flaw_count` | 13 |
| `total_review_negative_verified_count` | 13 |
| `quote_grounded_review_issue_count` | 0 |
| `obligation_grounded_review_issue_count` | 13 |
| `obligation_grounded_review_issue_claim_count` | 13 |
| `reviewer_candidate_review_issue_count` | 13 |
| `reviewer_candidate_review_issue_claim_count` | 13 |
...
| `verified_review_issue_row_count` | 13 |
| `verified_review_issue_claim_count` | 13 |
| `review_issue_bundle_count` | 13 |
...
| `verified_issue_without_recovery_count` | 8 |
| `verified_issue_cluster_without_recovery_count` | 4 |
| `review_issue_candidate_total` | 63 |
| `review_issue_candidate_verified` | 13 |
...
| `review_issue_candidate_missing_inventory_rejected` | 14 |
...
| `paper_text_negative_candidate_count` | 12 |
...
| `negative_evidence_linked_to_flaw_raw_count` | 13 |
...
| `negative_type_missing_ablation` | 9 |
...
| `verified_potential_concern_count` | 13 |
| `grounded_weakness_count` | 0 |
| `assessment_limitation_flaw_count` | 22 |
...
| `negative_evidence_semantic_rejected_count` | 13 |
| `downgraded_flaw_count` | 17 |
| `potential_concern_count` | 13 |
| `diagnosis_pending_potential_concern_count` | 114 |
...
| `coverage_gap_potential_concern_count` | 24 |
| `reviewer_inferred_potential_concern_count` | 26 |
| `final_potential_concern_total` | 29 |
| `diagnosis_pending_type_missing_ablation` | 12 |
...
| metric | P28_6_CONFLICTFIX_TARGETREFINE2_194911 |
|---|---|
| `verified_coverage_gap_count` | 24 |
| `coverage_gap_potential_concern_count` | 24 |
| `reviewer_inferred_potential_concern_count` | 26 |
| `final_potential_concern_total` | 29 |
...
| `contamination_stale_gap_persistence` | 7 |
...
| metric | P28_6_CONFLICTFIX_TARGETREFINE2_194911 |
|---|---|
| `contested_support_total` | 14 |
| `contested_final_support_total` | 11 |
| `claims_with_contested_support` | 6 |
| `claims_with_contested_final_support` | 6 |
| `open_conflict_count` | 36 |
| `contested_relation_final_count` | 12 |
| `contested_relation_added_count` | 14 |
| `contested_relation_effective_count` | 12 |
...
| `mark_contested_with_positive_support_count` | 14 |
| `mark_contested_with_verified_negative_evidence_count` | 14 |
| `mark_contested_final_view_count` | 14 |
| `contested_relation_with_positive_support_count` | 12 |
| `contested_relation_with_verified_negative_evidence_count` | 12 |
| `contested_relation_final_view_count` | 12 |

## Gap cleanup & locator

| metric | P28_6_CONFLICTFIX_TARGETREFINE2_194911 |
|---|---|
| `evidence_gap_open_count` | 27 |
| `evidence_gap_resolved_count` | 55 |
| `evidence_gap_superseded_count` | 0 |
| `evidence_gap_not_assessable_count` | 3 |
| `state_hygiene_open_gap_count` | 18 |
| `state_hygiene_stale_gap_count` | 9 |
| `targetless_open_gap_count` | 0 |
| `meta_or_context_open_gap_count` | 0 |
| `actionable_targeted_open_gap_count` | 0 |
| `diagnostic_targeted_open_gap_count` | 27 |
| `targeted_open_gap_count` | 27 |
...
| `programmatic_locator_type_section_count` | 19 |
...
| `recovery_patch_operation_mark_contested_turns` | 14 |
...
| `recovery_case_effective_repair_turns` | 14 |
| `recovery_case_effective_repair_not_verified_negative_repair` | 14 |
...
| `recovery_case_evidence_bucket_stale_reviewer_absence_audit` | 8 |
...
| code | P28_6_CONFLICTFIX_TARGETREFINE2_194911 | interpreted safety outcome |
|---|---|---|
...
| decision | P28_6_CONFLICTFIX_TARGETREFINE2_194911 |
|---|---|
| `reject` | 20 |
