...
| bucket::verified_review_issue_repair | 7 |
| case_rows | 29 |
...
| evidence_bucket::obligation_grounded_review_issue | 7 |
| evidence_bucket::quote-bank-negative-grounding_candidate | 2 |
| evidence_bucket::stale_reviewer_absence_audit | 2 |
...
| WNxlJJIEVj | 6 | verified_review_issue_repair | mark_contested | hygiene_delta_improved | claim:claim-1 | supported->supported | {"obligation_grounded_review_issue": 1} |
...
| WNxlJJIEVj | 6 | verified_review_issue_repair | evidence-reviewer-absence-claim-1-baseline-or-comparison-m | obligation_grounded_review_issue | missing_baseline | review_negative_absence_audit_verified | paper inventory #72 | missing/mismatch: same-setting comparison against high-retur; observed inventory: Next, we construct high variance datasets and evaluate the performance of CDiffuser and baselines on them. The results demonstrate the significant ... |
