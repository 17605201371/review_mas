...
- candidate: `mimo_v25_negqty_recoverycap_guard3_qhyg_targetneg_freeformrevneg_reviewissuebundle_hardneg20_mt7_b4w2_api2_r8t600_tok1536_20260629_202551.jsonl` (label: P28_CLUSTERGUARD_RECOMPUTE_202551, papers: 20)
...
| `hygiene_delta_or_safe_block_or_clean_state` | `>=` | 11 | smoke scaled from 20/39 | 14 | PASS |
| `real_strong_support_total` | `>=` | 16 | smoke scaled from 30/39 | 59 | PASS |
| `independent_support_group_total` | `>=` | 13 | smoke scaled from 24/39 | 56 | PASS |
...
| metric | P28_CLUSTERGUARD_RECOMPUTE_202551 |
|---|---|
| `evidence_agent_worker_turns` | 74 |
| `evidence_json_status_turns` | 66 |
| `evidence_json_valid_turns` | 66 |
...
| `evidence_json_raw_chars_median` | 1493 |
| `quote_bank_nonzero_turns` | 74 |
| `payload_evidence_item_total` | 125 |
...
| `small_model_quote_bank_augmentation_count` | 43 |
...
| `diagnostic_independent_support_group_total` | 74 |
...
| `primary_claims_with_deep_support` | 28 |
| `zero_real_papers` | 2 |
| `final_support_total` | 58 |
| `final_support_direct_strong_count` | 24 |
| `final_support_promoted_from_medium_count` | 34 |
...
| `support_trace_included_count` | 58 |
| `support_trace_dropped_count` | 76 |
...
| `final_support_weak_locator_count` | 17 |

## Negative & flaws

| metric | P28_CLUSTERGUARD_RECOMPUTE_202551 |
|---|---|
| `negative_evidence_candidate_count` | 15 |
| `negative_evidence_candidate_raw_count` | 15 |
| `review_negative_verified_count` | 0 |
| `reviewer_absence_verified_count` | 15 |
| `reviewer_absence_verified_claim_count` | 20 |
| `reviewer_absence_verified_flaw_count` | 15 |
| `total_review_negative_verified_count` | 15 |
| `quote_grounded_review_issue_count` | 0 |
| `obligation_grounded_review_issue_count` | 15 |
...
| `review_issue_candidate_generic_item_rejected` | 6 |
| `review_issue_candidate_counterevidence_rejected` | 49 |
| `review_issue_candidate_missing_inventory_rejected` | 30 |
| `review_issue_candidate_off_claim_rejected` | 1 |
...
| `verified_missing_ablation_high_confidence` | 11 |
...
| `paper_text_negative_candidate_count` | 26 |
...
| `negative_evidence_linked_to_flaw_count` | 15 |
| `negative_evidence_linked_to_flaw_raw_count` | 15 |
...
| `negative_type_missing_ablation` | 20 |
...
| `negative_grounding_conflict_count` | 15 |
| `invalid_negative_evidence_id_count_legacy` | 15 |
| `negative_semantic_anchor_conflict_count` | 15 |
...
| `diagnosis_pending_potential_concern_claim_count` | 55 |
...
| `diagnosis_pending_type_missing_baseline` | 25 |
...
| `diagnosis_pending_type_method_support_gap` | 22 |
...
| metric | P28_CLUSTERGUARD_RECOMPUTE_202551 |
|---|---|
| `state_contamination_count` | 24 |
| `state_contamination_count_legacy` | 24 |
| `harmful_state_contamination_count` | 0 |
| `repairable_state_warning_count` | 0 |
| `conservative_state_warning_count` | 24 |
| `state_hygiene_warning_count` | 24 |
| `weak_target_warning_count` | 24 |
| `repairable_contamination_target_count` | 0 |
| `conservative_contamination_target_count` | 24 |
...
| `contamination_evidence_misbinding` | 15 |
...
| `state_hygiene_open_gap_count` | 17 |
| `state_hygiene_stale_gap_count` | 8 |
...
| `programmatic_locator_type_generic_count` | 17 |
...
| `recovery_safe_resolution_or_clean_state` | 15 |
| `hygiene_delta_or_safe_block` | 12 |
| `hygiene_delta_or_safe_block_or_clean_state` | 14 |
...
| `recovery_target_gate_weak_target_turns` | 9 |
...
| `recovery_case_committed_not_effective` | 4 |
...
| `recovery_case_evidence_bucket_support_only` | 8 |
| `recovery_case_evidence_bucket_not_verified_or_unknown` | 2 |
...
| code | P28_CLUSTERGUARD_RECOMPUTE_202551 | interpreted safety outcome |
|---|---|---|
...
| `INVALID_STATUS_TRANSITION` | 3 | **unclassified_failure_requires_review** |
| `NO_EFFECT_PATCH` | 3 | **safe_blocked_patch (no state change needed)** |
| `SUCCESS` | 12 | **recovery_patch_committed** |
| `UNKNOWN_TARGET` | 1 | **unclassified_failure_requires_review** |

## Final decision distribution

| decision | P28_CLUSTERGUARD_RECOMPUTE_202551 |
|---|---|
| `reject` | 20 |
