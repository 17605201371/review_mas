...
- candidate: `mimo_v25_negqty_recoverycap_guard3_qhyg_targetneg_freeformrevneg_reviewissuebundle_hardneg20_mt7_b4w2_api2_r8t600_tok1536_20260628_093956.jsonl` (label: P28_FRESH_API_093956, papers: 20)
...
| metric | P28_FRESH_API_093956 |
|---|---|
| `negative_evidence_candidate_count` | 31 |
| `negative_evidence_candidate_raw_count` | 31 |
| `review_negative_verified_count` | 0 |
| `reviewer_absence_verified_count` | 31 |
| `reviewer_absence_verified_claim_count` | 29 |
| `reviewer_absence_verified_flaw_count` | 31 |
| `total_review_negative_verified_count` | 31 |
| `quote_grounded_review_issue_count` | 0 |
| `obligation_grounded_review_issue_count` | 31 |
| `obligation_grounded_review_issue_claim_count` | 29 |
| `reviewer_candidate_review_issue_count` | 26 |
| `reviewer_candidate_review_issue_claim_count` | 25 |
| `claim_obligation_review_issue_count` | 5 |
| `claim_obligation_review_issue_claim_count` | 5 |
| `verified_review_issue_count` | 31 |
| `verified_review_issue_claim_count` | 29 |
| `review_issue_bundle_count` | 31 |
| `verified_issue_without_recovery_count` | 20 |
...
| `review_issue_candidate_counterevidence_rejected` | 36 |
| `review_issue_candidate_missing_inventory_rejected` | 19 |
| `review_issue_candidate_off_claim_rejected` | 0 |
| `review_issue_type_missing_ablation` | 20 |
...
| `negative_evidence_linked_to_flaw_count` | 31 |
| `negative_evidence_linked_to_flaw_raw_count` | 31 |
| `negative_evidence_unlinked_to_flaw` | 0 |
| `verified_negative_flaw_count` | 37 |
| `verified_actionable_negative_flaw_count` | 37 |
| `verified_limitation_negative_flaw_count` | 0 |
| `negative_type_direct_contradiction` | 0 |
| `negative_type_negative_result` | 0 |
| `negative_type_missing_ablation` | 25 |
...
| `verified_potential_concern_count` | 37 |
...
| `final_potential_concern_total` | 48 |
...
| metric | P28_FRESH_API_093956 |
|---|---|
| `state_contamination_count` | 23 |
| `state_contamination_count_legacy` | 23 |
| `harmful_state_contamination_count` | 0 |
| `repairable_state_warning_count` | 0 |
| `conservative_state_warning_count` | 23 |
| `state_hygiene_warning_count` | 23 |
| `weak_target_warning_count` | 23 |
| `repairable_contamination_target_count` | 0 |
| `conservative_contamination_target_count` | 23 |
...
| metric | P28_FRESH_API_093956 |
|---|---|
| `contested_support_total` | 29 |
| `contested_final_support_total` | 10 |
| `claims_with_contested_support` | 13 |
...
| `state_hygiene_open_gap_count` | 21 |
| `state_hygiene_stale_gap_count` | 13 |
...
| `recovery_case_verified_review_issue_repair` | 11 |
| `verified_issue_contested_repair` | 11 |
...
| `recovery_case_turns_with_verified_review_issue_bundle_evidence` | 12 |
| `recovery_case_turns_with_reviewer_absence_audit_evidence` | 0 |
| `recovery_case_evidence_bucket_verified_review_negative` | 0 |
| `recovery_case_evidence_bucket_obligation_grounded_review_issue` | 13 |
...
| code | P28_FRESH_API_093956 | interpreted safety outcome |
|---|---|---|
