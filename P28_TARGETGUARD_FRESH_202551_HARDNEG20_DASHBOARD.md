...
- candidate: `mimo_v25_negqty_recoverycap_guard3_qhyg_targetneg_freeformrevneg_reviewissuebundle_hardneg20_mt7_b4w2_api2_r8t600_tok1536_20260629_202551.jsonl` (label: P28_TARGETGUARD_FRESH_202551, papers: 20)
...
| metric | P28_TARGETGUARD_FRESH_202551 |
|---|---|
...
| `reviewer_absence_verified_count` | 19 |
| `reviewer_absence_verified_claim_count` | 20 |
| `reviewer_absence_verified_flaw_count` | 19 |
| `total_review_negative_verified_count` | 19 |
| `quote_grounded_review_issue_count` | 0 |
| `obligation_grounded_review_issue_count` | 19 |
...
| `review_issue_candidate_missing_inventory_rejected` | 29 |
...
| `negative_type_missing_ablation` | 22 |
...
| `negative_grounding_conflict_count` | 11 |
| `invalid_negative_evidence_id_count_legacy` | 11 |
| `negative_semantic_anchor_conflict_count` | 11 |
...
| `final_potential_concern_total` | 41 |
...
| code | P28_TARGETGUARD_FRESH_202551 | interpreted safety outcome |
|---|---|---|
...
| decision | P28_TARGETGUARD_FRESH_202551 |
|---|---|
| `reject` | 20 |
