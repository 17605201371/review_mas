...
| cklg91aPGk | 4 | verified_review_issue_repair | evidence-reviewer-absence-claim-1-robustness-or-generaliza | obligation_grounded_review_issue | missing_robustness_or_generalization | review_negative_absence_audit_verified | Table 5 | missing/mismatch: evaluation on graph-level tasks (e.g., graph classification); observed inventory: Thanks to exclusion of transformation weights, PROPGCL demonstrates superior efficiency compared to corresponding baseline methods in terms of both... |
