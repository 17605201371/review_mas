...
- candidate: `mimo_v25_negqty_recoverycap_guard3_qhyg_targetneg_freeformrevneg_reviewissuebundle_hardneg20_mt7_b4w2_api2_r8t600_tok1536_20260701_160531.jsonl` (label: P29_DISCOVERY_EXPAND_MIMO_160531_TARGETGUARD3, papers: 20)
...
| `empirical_real_strong_support_count` | `>=` | 11 | smoke scaled from 20/39 | 36 | PASS |
...
| metric | P29_DISCOVERY_EXPAND_MIMO_160531_TARGETGUARD3 |
|---|---|
| `evidence_agent_worker_turns` | 78 |
| `evidence_json_status_turns` | 68 |
| `evidence_json_valid_turns` | 68 |
...
| `evidence_json_raw_chars_median` | 1445 |
| `quote_bank_nonzero_turns` | 78 |
| `payload_evidence_item_total` | 122 |
...
| `small_model_quote_bank_augmentation_count` | 52 |
...
| `independent_support_group_total` | 53 |
| `diagnostic_independent_support_group_total` | 71 |
| `claims_with_2plus_independent_or_diagnostic_support` | 21 |
| `empirical_real_strong_support_count` | 36 |
| `method_real_strong_support_count` | 17 |
...
| `claims_with_real_strong_support` | 40 |
| `claims_with_empirical_real_strong_support` | 28 |
| `claims_with_deep_support` | 30 |
| `claims_with_2plus_independent_support` | 13 |
| `primary_claim_total` | 60 |
| `primary_claims_with_real_strong_support` | 36 |
| `primary_claims_with_empirical_support` | 25 |
| `primary_claims_with_deep_support` | 27 |
| `zero_real_papers` | 2 |
...
| `support_trace_weak_support_depth_count` | 16 |
| `support_trace_semantic_mismatch_count` | 18 |
| `support_trace_duplicate_quote_count` | 5 |
| `support_trace_missing_verified_quote_count` | 0 |
| `final_support_specific_locator_count` | 35 |
| `final_support_weak_locator_count` | 18 |

## Negative & flaws

| metric | P29_DISCOVERY_EXPAND_MIMO_160531_TARGETGUARD3 |
|---|---|
| `negative_evidence_candidate_count` | 20 |
| `negative_evidence_candidate_raw_count` | 20 |
...
| `total_review_negative_verified_count` | 20 |
...
| `verified_review_issue_row_count` | 20 |
| `verified_review_issue_claim_count` | 18 |
...
| `claim_obligation_review_issue_cluster_count` | 2 |
...
| `verified_review_issue_cluster_slot_protocol_or_reproducibility_count` | 4 |
...
| `verified_issue_without_recovery_count` | 11 |
...
| `review_issue_candidate_missing_baseline_target_rejected` | 9 |
| `review_issue_candidate_missing_baseline_generic_target_rejected` | 9 |
...
| `review_issue_candidate_slot_missing_baseline` | 16 |
...
| `review_issue_candidate_slot_efficiency_cost` | 6 |
...
| `paper_text_negative_candidate_count` | 31 |
...
| `negative_evidence_linked_to_flaw_count` | 20 |
| `negative_evidence_linked_to_flaw_raw_count` | 20 |
| `negative_evidence_unlinked_to_flaw` | 0 |
| `verified_negative_flaw_count` | 24 |
| `verified_actionable_negative_flaw_count` | 24 |
...
| `negative_type_missing_baseline` | 4 |
...
| `negative_type_evaluation_protocol_risk` | 4 |
...
| `verified_potential_concern_count` | 24 |
...
| `downgraded_flaw_count` | 18 |
| `potential_concern_count` | 24 |
| `diagnosis_pending_potential_concern_count` | 111 |
...
| `diagnosis_pending_type_missing_ablation` | 5 |
...
| `diagnosis_pending_type_missing_robustness_or_generalization` | 3 |
| `diagnosis_pending_type_evaluation_protocol_risk` | 10 |
| `diagnosis_pending_type_efficiency_cost_gap` | 4 |
| `diagnosis_pending_type_reproducibility_gap` | 10 |
| `diagnosis_pending_type_scope_overclaim` | 10 |
| `diagnosis_pending_type_result_claim_mismatch` | 0 |
| `diagnosis_pending_type_method_support_gap` | 18 |
...
| `contested_final_support_total` | 13 |
| `claims_with_contested_support` | 12 |
| `claims_with_contested_final_support` | 11 |
| `open_conflict_count` | 48 |
| `contested_relation_final_count` | 10 |
| `contested_relation_added_count` | 11 |
| `contested_relation_effective_count` | 9 |
...
| `mark_contested_with_positive_support_count` | 10 |
| `mark_contested_with_verified_negative_evidence_count` | 11 |
| `mark_contested_final_view_count` | 11 |
| `contested_relation_with_positive_support_count` | 9 |
| `contested_relation_with_verified_negative_evidence_count` | 10 |
| `contested_relation_final_view_count` | 10 |
...
| `programmatic_locator_type_generic_count` | 18 |
| `programmatic_high_confidence_locator_count` | 33 |
...
| metric | P29_DISCOVERY_EXPAND_MIMO_160531_TARGETGUARD3 |
|---|---|
| `recovery_attempted` | 33 |
| `recovery_patch_validated` | 24 |
| `recovery_patch_committed` | 16 |
| `recovery_committed` | 16 |
| `recovery_success` | 16 |
| `hygiene_delta_improved` | 11 |
| `diagnosis_pending_recorded_layer` | 4 |
| `recovery_effective_repair` | 11 |
| `recovery_no_effect_commit` | 0 |
| `recovery_harmful_commit_risk` | 0 |
| `recovery_harmful_commit_committed` | 0 |
| `recovery_unsafe_downgrade_attempt_blocked` | 3 |
...
| `recovery_target_gate_real_target_turns` | 12 |
...
| `recovery_patch_operation_reject_patch_turns` | 17 |
...
| `recovery_patch_operation_mark_contested_turns` | 11 |
...
| `recovery_case_attempted_not_committed` | 20 |
| `recovery_case_committed_not_effective` | 5 |
| `recovery_case_effective_repair_turns` | 11 |
| `recovery_case_effective_repair_not_verified_negative_repair` | 11 |
| `recovery_case_turns_with_verified_review_negative_evidence` | 4 |
...
| `recovery_case_evidence_bucket_verified_review_negative` | 4 |
...
| `recovery_case_evidence_bucket_missing_evidence_id` | 4 |
...
| code | P29_DISCOVERY_EXPAND_MIMO_160531_TARGETGUARD3 | interpreted safety outcome |
|---|---|---|
| `ACTIONABLE_CONCERN_PRESERVED` | 2 | **safe_terminal_block (verified potential concern preserved)** |
...
| `INSUFFICIENT_EVIDENCE` | 3 | **safe_blocked_patch (insufficient evidence criteria)** |
...
| `SUCCESS` | 16 | **recovery_patch_committed** |

## Final decision distribution

| decision | P29_DISCOVERY_EXPAND_MIMO_160531_TARGETGUARD3 |
|---|---|
| `reject` | 20 |
