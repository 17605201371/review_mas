...
- candidate: `mimo_v25_negqty_recoverycap_guard3_qhyg_targetneg_freeformrevneg_reviewissuebundle_hardneg20_mt7_b4w2_api4_r8t600_tok1536_20260701_211251.jsonl` (label: P30_FRESH_API4_211251, papers: 20)
...
| `independent_support_group_total` | `>=` | 13 | smoke scaled from 24/39 | 68 | PASS |
| `empirical_real_strong_support_count` | `>=` | 11 | smoke scaled from 20/39 | 52 | PASS |
| `claims_with_deep_support` | `>=` | 5 | smoke scaled from 8/39 | 40 | PASS |
...
| `programmatic_specific_locator_count` | `>=` | 10 | smoke scaled from 18/39 | 46 | PASS |

**Overall protection: PASS**

## Evidence formation health

| metric | P30_FRESH_API4_211251 |
|---|---|
| `evidence_agent_worker_turns` | 71 |
...
| `independent_support_group_total` | 68 |
| `diagnostic_independent_support_group_total` | 86 |
| `claims_with_2plus_independent_or_diagnostic_support` | 29 |
| `empirical_real_strong_support_count` | 52 |
| `method_real_strong_support_count` | 17 |
| `table_or_figure_real_strong_support_count` | 31 |
...
| `support_trace_total` | 138 |
| `support_trace_included_count` | 69 |
| `support_trace_dropped_count` | 69 |
| `support_trace_hygiene_filtered_count` | 23 |
| `support_trace_overridden_by_negative_burden_count` | 0 |
| `support_trace_weak_support_depth_count` | 20 |
...
| `final_support_specific_locator_count` | 46 |
...
| `reviewer_absence_verified_claim_count` | 13 |
...
| `obligation_grounded_review_issue_cluster_count` | 12 |
...
| `verified_review_issue_cluster_recomputed_count` | 12 |
...
| `verified_review_issue_cluster_slot_protocol_or_reproducibility_count` | 3 |
...
| `verified_issue_without_recovery_count` | 5 |
| `verified_issue_cluster_without_recovery_count` | 4 |
| `review_issue_candidate_total` | 88 |
...
| `review_issue_candidate_counterevidence_rejected` | 44 |
| `review_issue_candidate_missing_inventory_rejected` | 22 |
| `review_issue_candidate_off_claim_rejected` | 0 |
| `review_issue_candidate_review_worthiness_rejected` | 11 |
| `review_issue_candidate_missing_ablation_target_rejected` | 9 |
...
| `review_issue_candidate_deterministic_seed_count` | 57 |
...
| `review_issue_type_evaluation_protocol_risk` | 1 |
...
| `review_issue_cluster_type_evaluation_protocol_risk` | 1 |
...
| `paper_text_negative_candidate_count` | 11 |
...
| `verified_negative_flaw_count` | 15 |
| `verified_actionable_negative_flaw_count` | 15 |
...
| `verified_potential_concern_count` | 15 |
...
| `downgraded_flaw_count` | 4 |
| `potential_concern_count` | 15 |
| `diagnosis_pending_potential_concern_count` | 92 |
...
| `reviewer_inferred_potential_concern_count` | 22 |
| `final_potential_concern_total` | 32 |
...
| `diagnosis_pending_type_insufficient_evaluation` | 20 |
...
| `contamination_stale_gap_persistence` | 6 |
...
| `contested_final_support_total` | 8 |
...
| `programmatic_high_confidence_locator_count` | 46 |
...
| metric | P30_FRESH_API4_211251 |
|---|---|
| `recovery_attempted` | 18 |
| `recovery_patch_validated` | 11 |
...
| `hygiene_delta_or_safe_block` | 13 |
...
| code | P30_FRESH_API4_211251 | interpreted safety outcome |
|---|---|---|
...
| decision | P30_FRESH_API4_211251 |
|---|---|
| `reject` | 20 |
