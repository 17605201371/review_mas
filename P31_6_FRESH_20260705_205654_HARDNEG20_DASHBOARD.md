...
| `verified_review_issue_row_count` | 10 |
| `verified_review_issue_claim_count` | 10 |
| `review_issue_bundle_count` | 9 |
...
| `verified_review_issue_cluster_origin_deterministic_seed_count` | 1 |
...
| `verified_review_issue_cluster_slot_missing_ablation_count` | 2 |
...
| `verified_missing_ablation_cluster_count` | 2 |
...
| `critique_selected_verified_cluster_detail_count` | 6 |
...
| `deterministic_seed_verified_cluster_count` | 0 |
...
| `candidate_menu_item_failed_stage_counterevidence` | 4 |
...
| `review_issue_cluster_type_missing_ablation` | 2 |
...
| `negative_evidence_linked_to_flaw_raw_count` | 10 |
...
| `verified_potential_concern_count` | 10 |
| `grounded_weakness_count` | 0 |
| `assessment_limitation_flaw_count` | 38 |
...
| `negative_evidence_semantic_rejected_count` | 21 |
| `downgraded_flaw_count` | 29 |
...
| `final_potential_concern_total` | 22 |
...
| `state_contamination_count_legacy` | 6 |
...
| `warning_stale_gap_persistence` | 3 |
...
| `state_hygiene_stale_gap_count` | 4 |
...
| `stale_absence_contested_repair` | 11 |
...
| `recovery_case_effective_repair_without_verified_negative` | 11 |
...
| `recovery_case_evidence_bucket_stale_reviewer_absence_audit` | 12 |
