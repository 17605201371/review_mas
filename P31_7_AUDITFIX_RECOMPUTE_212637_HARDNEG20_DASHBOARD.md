...
- candidate: `mimo_v25_negqty_recoverycap_guard3_qhyg_targetneg_freeformrevneg_reviewissuebundle_hardneg20_mt7_b4w2_api4_r8t600_tok1536_20260703_212637.jsonl` (label: P31_7_AUDITFIX_RECOMPUTE_212637, papers: 20)
...
| metric | P31_7_AUDITFIX_RECOMPUTE_212637 |
|---|---|
...
| `review_issue_seed_topup_turns` | 9 |
| `review_issue_seed_topup_candidate_count` | 56 |
...
| `obligation_grounded_review_issue_claim_count` | 19 |
...
| `reviewer_candidate_review_issue_deterministic_seed_count` | 17 |
...
| `verified_review_issue_cluster_recomputed_count` | 13 |
| `quote_grounded_review_issue_cluster_count` | 1 |
| `quote_grounded_direct_quote_duplicate_cluster_count` | 0 |
| `quote_duplicate_merged_verified_review_issue_cluster_count` | 13 |
...
| `review_issue_candidate_missing_inventory_rejected` | 3 |
...
| `contamination_stale_gap_persistence` | 9 |
...
| code | P31_7_AUDITFIX_RECOMPUTE_212637 | interpreted safety outcome |
|---|---|---|
...
| decision | P31_7_AUDITFIX_RECOMPUTE_212637 |
|---|---|
| `reject` | 20 |
