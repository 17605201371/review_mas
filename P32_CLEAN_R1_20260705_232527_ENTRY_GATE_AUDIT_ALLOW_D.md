...
| `case_table_cluster_count_matches_rows_minus_duplicates` | 17 | 17 | PASS |
| `dashboard_case_cluster_count_match` | 17 | 17 | PASS |
| `dashboard_recomputed_cluster_count_match` | 17 | 17 | PASS |
| `dashboard_quote_merged_cluster_count_not_above_system` | 17 | <= 17 | PASS |
| `dashboard_origin_cluster_counts_sum` | 17 | 17 | PASS |
...
| `cluster_count_by_origin` | {'claim_obligation': 2, 'critique_payload': 6, 'deterministic_seed': 7, 'quote_grounded': 2} |
...
| a6SntIisgg | scope_overclaim | held-out_coverage_for_source-to-target | claim-3 | held-out or coverage evaluation for source-to-target | Figure: model |
...
| a6SntIisgg | scope_overclaim | held-out_coverage_for_source-to-target | rim-c3-sr-held-out-or-coverage-evaluation | critique_direct_verified_cluster |
