...
- candidate: `mimo_v25_negqty_recoverycap_guard3_qhyg_targetneg_freeformrevneg_reviewissuebundle_hardneg20_mt7_b4w2_api4_r8t600_tok2048_20260705_232528.jsonl` (label: P32_CLEAN_R1_PRECISION_RECOMPUTE_20260705_232527, papers: 20)
...
| metric | P32_CLEAN_R1_PRECISION_RECOMPUTE_20260705_232527 |
|---|---|
...
| `reviewer_candidate_review_issue_critique_payload_count` | 5 |
...
| `claim_obligation_review_issue_claim_count` | 1 |
...
| `obligation_grounded_review_issue_cluster_count` | 10 |
...
| `verified_review_issue_cluster_origin_deterministic_seed_count` | 6 |
...
| `verified_issue_without_recovery_count` | 3 |
...
| `critique_payload_bundle_built_count` | 5 |
| `critique_payload_verified_count` | 5 |
| `critique_payload_menu_bound_verified_count` | 5 |
| `critique_payload_verified_cluster_count` | 5 |
| `critique_direct_verified_cluster_count` | 5 |
| `critique_selected_verified_cluster_count` | 5 |
| `critique_selected_existing_seed_cluster_count` | 0 |
| `critique_selected_verified_by_existing_cluster_count` | 0 |
| `critique_selected_verified_cluster_detail_count` | 4 |
...
| `deterministic_seed_verified_cluster_count` | 5 |
...
| `candidate_menu_item_failed_count` | 9 |
| `candidate_menu_item_failed_detail_count` | 9 |
...
| `candidate_menu_item_failed_stage_counterevidence` | 7 |
...
| `verified_missing_ablation_medium_confidence` | 6 |
...
| `review_issue_verified_slot_missing_ablation` | 11 |
...
| `positive_or_neutral_negative_unlinked_rejected_count` | 1 |
...
| `verified_potential_concern_count` | 17 |
...
| `negative_evidence_semantic_rejected_count` | 9 |
| `downgraded_flaw_count` | 11 |
| `potential_concern_count` | 17 |
...
| metric | P32_CLEAN_R1_PRECISION_RECOMPUTE_20260705_232527 |
|---|---|
| `contested_support_total` | 33 |
| `contested_final_support_total` | 17 |
| `claims_with_contested_support` | 16 |
| `claims_with_contested_final_support` | 13 |
...
| `recovery_case_verified_review_issue_repair` | 17 |
| `verified_issue_contested_repair` | 17 |
...
| `recovery_case_turns_with_verified_review_issue_bundle_evidence` | 17 |
...
| `recovery_case_evidence_bucket_stale_reviewer_absence_audit` | 6 |
...
| code | P32_CLEAN_R1_PRECISION_RECOMPUTE_20260705_232527 | interpreted safety outcome |
|---|---|---|
...
| decision | P32_CLEAN_R1_PRECISION_RECOMPUTE_20260705_232527 |
|---|---|
| `reject` | 20 |
