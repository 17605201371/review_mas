...
- manual audit validation: `P32_CLEAN_R3_PRECISION_RECOMPUTE_20260706_010000_MANUAL_AUDIT_VALIDATION.json`
- machine gate: **PASS**
- manual gate: **PASS**
...
| `unfilled_clusters` | 0 |
| `manual_A_B_clusters_by_origin` | {'critique_payload': 5, 'deterministic_seed': 2} |
| `manual_D_clusters_by_origin` | {} |
| `cluster_count_by_origin` | {'critique_payload': 6, 'deterministic_seed': 3} |
