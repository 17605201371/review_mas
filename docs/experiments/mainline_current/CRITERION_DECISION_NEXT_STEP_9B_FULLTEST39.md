...
- Sim 4 的 combined rule 在 strict 映射下仍产生 2 个 false accept，且 recovered accept 为 0；说明当前 criterion 信号和 support-quality 信号还不足以安全推动 accept-like decision。
...
- macro_f1: 0.4179
- accept_recall: 0.0
- reject_recall: 0.9333
- predicted_accept_count: 2
- predicted_borderline_count: 6
- false_accept_ids: rEqETC88RY, kam84eEmub
