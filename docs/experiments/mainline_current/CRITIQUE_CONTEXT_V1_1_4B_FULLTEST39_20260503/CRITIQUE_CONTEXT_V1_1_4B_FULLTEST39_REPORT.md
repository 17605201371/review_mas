...
| nonabstract_strong_support_total | 36 |
| empirical_strong_support_total | 27 |
| method_strong_support_total | 9 |
| table_or_figure_strong_support_total | 0 |
| ablation_strong_support_total | 25 |
| abstract_strong_support_total | 0 |
| fallback_strong_support_total | 0 |
| strong_support_binding_precision | 1.0 |
| rows_with_2plus_real_strong_support | 9 |
| accept_rows_with_2plus_real_strong_support | 1 |
| rows_with_empirical_support | 19 |
...
| metric | value |
| --- | --- |
| evidence_json_status_counts | {'json_valid': 145, 'no_json_object': 6, 'invalid_json': 1} |
| evidence_json_status_turn_count | 152 |
| evidence_json_invalid_or_missing_count | 7 |
...
| metric | value |
| --- | --- |
| unresolved_count | 215 |
| evidence_gap_count | 119 |
| flaw_count | 48 |
| conflict_note_count | 52 |
| patch_emitted_count | 97 |
| patch_validated_count | 88 |
| patch_committed_count | 3 |
| rows_with_any_commit | 3 |
| model_generated_commit_count | 3 |
| system_salvaged_commit_count | 0 |
| recovery_failure_code_counts | {'blocked_by_policy': 18, 'insufficient_evidence': 61, 'invalid_status_transition': 9, 'unresolved_conflict': 2, 'evidence_target_mismatch': 1, 'no_effect_patch': 3, 'success': 3} |
...
| policy_source_counts | {'manager_model': 41, 's4_clarification_to_evidence_override': 25, 'flaw_progress_override': 35, 's4_preclaim_clarification_override': 21, 'evidence_progress_override': 111, 's4_evidence_to_flaw_override': 3, 'recovery_phase_override': 4} |
