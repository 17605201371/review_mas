...
| metric | value |
| --- | --- |
| real_strong_total | 36 |
| strong_abstract | 0 |
| strong_method | 9 |
| strong_empirical_result | 14 |
| strong_table_or_figure | 11 |
| strong_ablation | 2 |
| strong_unknown | 0 |
| fallback_or_unbound_strong | 0 |
| independent_group_total | 36 |
| rows_with_2plus_independent_groups | 9 |
| rows_with_method_plus_empirical | 3 |

## 逐样本

| paper_id | gold | pred | real | abstract | method | result | table_fig | ablation | independent_groups | method_plus_empirical |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ye3NrNrYOY | reject | reject | 4 | 0 | 1 | 0 | 2 | 1 | 4 | True |
...
| BXY6fe7q31 | accept | reject | 1 | 0 | 1 | 0 | 0 | 0 | 1 | False |
...
| YXn76HMetm | reject | reject | 2 | 0 | 0 | 1 | 1 | 0 | 2 | False |
...
| WLgbjzKJkk | reject | reject | 1 | 0 | 0 | 0 | 0 | 1 | 1 | False |
