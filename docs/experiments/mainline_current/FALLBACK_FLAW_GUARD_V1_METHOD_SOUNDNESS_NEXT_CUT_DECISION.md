...
- gold accept 数：9
- accept_like 数：0
- borderline_positive 数：5
- gold accept 中具备 method support 的样本数：1
- gold accept 中 soundness positive 的样本数：1
- runtime false accept：none
- gold accept blocker family：{'hard_negative_burden': 5, 'method_soundness_gap': 3, 'support_depth_gap': 1}
- borderline blocker family：{'method_soundness_gap': 1, 'support_depth_gap': 1, 'hard_negative_burden': 3}
