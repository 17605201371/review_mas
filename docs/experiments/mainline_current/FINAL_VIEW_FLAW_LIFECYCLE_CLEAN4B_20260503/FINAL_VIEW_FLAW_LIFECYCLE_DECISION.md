...
- derived strict: `predicted_accept_count=6`, `accept_recall=0.2222`, `reject_recall=0.8667`, `macro_f1=0.5460`。
- derived labels: `{'not_assessable': 7, 'borderline': 20, 'accept_like': 6, 'reject_like': 6}`。
- flaw meta/artifact burden: excerpt/system/fallback/malformed 相关项大量存在，例如 `flaw_excerpt_limitation=7`, `flaw_system_meta_limitation=3`, `flaw_fallback_or_malformed_artifact=15`。
