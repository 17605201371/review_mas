...
- derived strict: `predicted_accept_count=0`, `accept_recall=0.0000`, `reject_recall=1.0000`, `macro_f1=0.4348`。
- derived labels: `{'borderline': 15, 'not_assessable': 18, 'reject_like': 6}`。
- flaw meta/artifact burden: excerpt/system/fallback/malformed 相关项大量存在，例如 `flaw_excerpt_limitation=17`, `flaw_system_meta_limitation=1`, `flaw_fallback_or_malformed_artifact=20`。
