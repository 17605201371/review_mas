...
| `hygiene`                 | 23 | 17 | 6 | 0 | **0.7391** |
| `hygiene_evidence_aware`  | 27 | 19 | 8 | 0 | **0.7037** |
...
- filtered_out_total: **39** (raw-visible flaws that hygiene moved out of candidate/confirmed, plus flaws that were never visible)
- hygiene true positives (filtered & not_grounded by judge): **18**
- hygiene false negatives (filtered but actually paper_grounded): **21**
- **Hygiene_Precision** = 0.4615 (higher = hygiene was more correct in what it filtered)
- Hygiene_FN_Rate     = 0.5385 (real grounded flaws lost to over-aggressive hygiene)
