...
- candidate: `local_deepseek_v3_batch2.jsonl` (label: deepseek_batch2, papers: 8)
...
| `recovery_safe_resolution` | `>=` | 5 | smoke scaled from 20/39 | 6 | PASS |
| `hygiene_delta_or_safe_block` | `>=` | 5 | smoke scaled from 20/39 | 6 | PASS |
| `real_strong_support_total` | `>=` | 7 | smoke scaled from 30/39 | 16 | PASS |
| `independent_support_group_total` | `>=` | 5 | smoke scaled from 24/39 | 16 | PASS |
| `empirical_real_strong_support_count` | `>=` | 5 | smoke scaled from 20/39 | 15 | PASS |
| `claims_with_deep_support` | `>=` | 2 | smoke scaled from 8/39 | 12 | PASS |
...
| `programmatic_specific_locator_count` | `>=` | 4 | smoke scaled from 18/39 | 5 | PASS |

**Overall protection: FAIL**

## Evidence formation health

| metric | deepseek_batch2 |
|---|---|
| `evidence_agent_worker_turns` | 47 |
| `quote_bank_nonzero_turns` | 45 |
| `payload_evidence_item_total` | 52 |
| `evidence_agent_nonempty_payload_turns` | 35 |
...
| metric | deepseek_batch2 |
|---|---|
| `real_strong_support_total` | 16 |
| `independent_support_group_total` | 16 |
| `diagnostic_independent_support_group_total` | 0 |
| `claims_with_2plus_independent_or_diagnostic_support` | 0 |
| `empirical_real_strong_support_count` | 15 |
| `method_real_strong_support_count` | 0 |
...
| `moderate_absorbed_into_final_strong_count` | 4 |
| `moderate_remaining_diagnostic_count` | 24 |
| `diagnostic_support_signal_total` | 40 |
...
| `claims_with_empirical_real_strong_support` | 12 |
| `claims_with_deep_support` | 12 |
| `claims_with_2plus_independent_support` | 4 |
| `primary_claim_total` | 24 |
| `primary_claims_with_real_strong_support` | 9 |
| `primary_claims_with_empirical_support` | 9 |
| `primary_claims_with_deep_support` | 9 |
| `zero_real_papers` | 0 |
| `final_support_total` | 16 |
| `final_support_direct_strong_count` | 11 |
| `final_support_promoted_from_medium_count` | 4 |
...
| `support_trace_total` | 48 |
| `support_trace_included_count` | 16 |
| `support_trace_dropped_count` | 32 |
...
| `final_support_specific_locator_count` | 5 |
...
| `verified_limitation_negative_flaw_count` | 3 |
...
| `negative_type_scope_limitation` | 3 |
...
| metric | deepseek_batch2 |
|---|---|
| `state_contamination_count` | 3 |
| `state_contamination_count_legacy` | 3 |
...
| `contamination_unsupported_with_strong_support` | 2 |
...
| metric | deepseek_batch2 |
|---|---|
| `evidence_gap_open_count` | 4 |
| `evidence_gap_resolved_count` | 26 |
| `evidence_gap_superseded_count` | 0 |
| `evidence_gap_not_assessable_count` | 0 |
| `state_hygiene_open_gap_count` | 4 |
...
| `programmatic_high_confidence_locator_count` | 5 |
...
| code | deepseek_batch2 | interpreted safety outcome |
|---|---|---|
