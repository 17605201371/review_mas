...
| metric | GUARDED1000 | SUPPORTRECHECK_1753 | delta |
|---|---|---|---|
| `evidence_agent_worker_turns` | 42 | 43 | +1 |
| `quote_bank_nonzero_turns` | 42 | 43 | +1 |
| `payload_evidence_item_total` | 70 | 75 | +5 |
| `evidence_agent_nonempty_payload_turns` | 39 | 43 | +4 |
| `evidence_agent_question_only_turns` | 2 | 3 | +1 |
...
| `small_model_quote_bank_augmentation_count` | 32 | 42 | +10 |
...
| metric | GUARDED1000 | SUPPORTRECHECK_1753 | delta |
|---|---|---|---|
| `real_strong_support_total` | 35 | 47 | +12 |
| `independent_support_group_total` | 35 | 47 | +12 |
| `diagnostic_independent_support_group_total` | 35 | 47 | +12 |
| `claims_with_2plus_independent_or_diagnostic_support` | 17 | 21 | +4 |
| `empirical_real_strong_support_count` | 21 | 32 | +11 |
| `method_real_strong_support_count` | 14 | 15 | +1 |
...
| `moderate_absorbed_into_final_strong_count` | 23 | 23 | 0 |
| `moderate_remaining_diagnostic_count` | 0 | 0 | 0 |
| `diagnostic_support_signal_total` | 35 | 47 | +12 |
...
| `claims_with_real_strong_support` | 17 | 26 | +9 |
| `claims_with_empirical_real_strong_support` | 13 | 21 | +8 |
| `claims_with_deep_support` | 17 | 25 | +8 |
| `claims_with_2plus_independent_support` | 17 | 21 | +4 |
| `primary_claim_total` | 24 | 24 | 0 |
| `primary_claims_with_real_strong_support` | 16 | 22 | +6 |
| `primary_claims_with_empirical_support` | 12 | 17 | +5 |
| `primary_claims_with_deep_support` | 16 | 21 | +5 |
| `zero_real_papers` | 0 | 0 | 0 |
| `final_support_total` | 35 | 47 | +12 |
| `final_support_direct_strong_count` | 12 | 24 | +12 |
| `final_support_promoted_from_medium_count` | 23 | 23 | 0 |
...
| `support_trace_total` | 35 | 48 | +13 |
| `support_trace_included_count` | 35 | 47 | +12 |
...
| `final_support_specific_locator_count` | 19 | 28 | +9 |
| `final_support_weak_locator_count` | 16 | 19 | +3 |
...
| metric | GUARDED1000 | SUPPORTRECHECK_1753 | delta |
|---|---|---|---|
| `contested_support_total` | 4 | 5 | +1 |
| `contested_final_support_total` | 4 | 5 | +1 |
...
| `evidence_gap_resolved_count` | 17 | 26 | +9 |
| `evidence_gap_superseded_count` | 0 | 0 | 0 |
| `evidence_gap_not_assessable_count` | 11 | 5 | -6 |
...
| `programmatic_specific_locator_count` | 19 | 28 | +9 |
| `programmatic_weak_locator_count` | 16 | 19 | +3 |
| `programmatic_locator_type_table_count` | 1 | 6 | +5 |
| `programmatic_locator_type_figure_count` | 6 | 7 | +1 |
| `programmatic_locator_type_section_count` | 11 | 14 | +3 |
| `programmatic_locator_type_algorithm_count` | 0 | 0 | 0 |
| `programmatic_locator_type_theorem_count` | 1 | 1 | 0 |
| `programmatic_locator_type_generic_count` | 16 | 19 | +3 |
| `programmatic_high_confidence_locator_count` | 19 | 28 | +9 |
...
| `recovery_safe_resolution` | 3 | 9 | +6 |
| `recovery_safe_resolution_or_clean_state` | 8 | 8 | 0 |
| `hygiene_delta_or_safe_block` | 1 | 9 | +8 |
| `hygiene_delta_or_safe_block_or_clean_state` | 8 | 8 | 0 |
| `recovery_safe_blocked_weak_target` | 1 | 8 | +7 |
| `recovery_target_gate_real_target_turns` | 2 | 1 | -1 |
| `recovery_target_gate_weak_target_turns` | 1 | 8 | +7 |
| `recovery_target_gate_fallback_target_turns` | 1 | 0 | -1 |
| `recovery_target_gate_empty_target_turns` | 0 | 0 | 0 |
| `recovery_patch_operation_reject_patch_turns` | 2 | 8 | +6 |
...
| code | GUARDED1000 | SUPPORTRECHECK_1753 | delta | interpreted safety outcome |
|---|---|---|---|---|
| `BLOCKED_BY_POLICY` | 2 | 8 | +6 | **safe_blocked_patch (policy restriction/abstention)** |
| `SUCCESS` | 2 | 1 | -1 | **recovery_patch_committed** |

## Final decision distribution

| decision | GUARDED1000 | SUPPORTRECHECK_1753 |
|---|---|---|
| `accept` | 5 | 5 |
| `reject` | 3 | 3 |
