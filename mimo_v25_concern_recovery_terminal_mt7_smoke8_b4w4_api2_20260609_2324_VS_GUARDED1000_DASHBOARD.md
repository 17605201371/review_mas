...
| metric | GUARDED1000 | TERMINAL_2324 | delta |
|---|---|---|---|
| `evidence_agent_worker_turns` | 42 | 39 | -3 |
| `quote_bank_nonzero_turns` | 42 | 39 | -3 |
| `payload_evidence_item_total` | 70 | 60 | -10 |
| `evidence_agent_nonempty_payload_turns` | 39 | 38 | -1 |
| `evidence_agent_question_only_turns` | 2 | 4 | +2 |
| `first_support_fallback_turns` | 2 | 8 | +6 |
| `model_adapter_quote_first_rewrite_count` | 0 | 0 | 0 |
| `model_adapter_strength_downgrade_count` | 0 | 0 | 0 |
| `small_model_quote_bank_augmentation_count` | 32 | 31 | -1 |
...
| metric | GUARDED1000 | TERMINAL_2324 | delta |
|---|---|---|---|
| `real_strong_support_total` | 35 | 38 | +3 |
| `independent_support_group_total` | 35 | 38 | +3 |
| `diagnostic_independent_support_group_total` | 35 | 39 | +4 |
| `claims_with_2plus_independent_or_diagnostic_support` | 17 | 19 | +2 |
| `empirical_real_strong_support_count` | 21 | 27 | +6 |
| `method_real_strong_support_count` | 14 | 11 | -3 |
| `table_or_figure_real_strong_support_count` | 14 | 19 | +5 |
| `result_or_experiment_real_strong_support_count` | 7 | 6 | -1 |
...
| `diagnostic_support_signal_total` | 35 | 39 | +4 |
...
| `claims_with_real_strong_support` | 17 | 20 | +3 |
| `claims_with_empirical_real_strong_support` | 13 | 16 | +3 |
| `claims_with_deep_support` | 17 | 19 | +2 |
| `claims_with_2plus_independent_support` | 17 | 18 | +1 |
| `primary_claim_total` | 24 | 24 | 0 |
| `primary_claims_with_real_strong_support` | 16 | 19 | +3 |
| `primary_claims_with_empirical_support` | 12 | 15 | +3 |
| `primary_claims_with_deep_support` | 16 | 18 | +2 |
| `zero_real_papers` | 0 | 0 | 0 |
| `final_support_total` | 35 | 38 | +3 |
| `final_support_direct_strong_count` | 12 | 14 | +2 |
...
| `support_trace_total` | 35 | 39 | +4 |
| `support_trace_included_count` | 35 | 38 | +3 |
...
| `final_support_specific_locator_count` | 19 | 24 | +5 |
| `final_support_weak_locator_count` | 16 | 14 | -2 |
...
| metric | GUARDED1000 | TERMINAL_2324 | delta |
|---|---|---|---|
| `contested_support_total` | 4 | 4 | 0 |
| `contested_final_support_total` | 4 | 4 | 0 |
| `claims_with_contested_support` | 2 | 2 | 0 |
...
| `evidence_gap_resolved_count` | 17 | 20 | +3 |
| `evidence_gap_superseded_count` | 0 | 0 | 0 |
| `evidence_gap_not_assessable_count` | 11 | 8 | -3 |
...
| `unresolved_open_raw_count` | 21 | 24 | +3 |
| `unresolved_resolved_count` | 0 | 0 | 0 |
| `unresolved_deferred_count` | 21 | 24 | +3 |
| `targetless_unresolved_deferred_count` | 0 | 0 | 0 |
| `programmatic_specific_locator_count` | 19 | 24 | +5 |
| `programmatic_weak_locator_count` | 16 | 14 | -2 |
| `programmatic_locator_type_table_count` | 1 | 2 | +1 |
| `programmatic_locator_type_figure_count` | 6 | 14 | +8 |
| `programmatic_locator_type_section_count` | 11 | 8 | -3 |
| `programmatic_locator_type_algorithm_count` | 0 | 0 | 0 |
| `programmatic_locator_type_theorem_count` | 1 | 0 | -1 |
| `programmatic_locator_type_generic_count` | 16 | 14 | -2 |
| `programmatic_high_confidence_locator_count` | 19 | 24 | +5 |
...
| `hygiene_delta_or_safe_block` | 1 | 6 | +5 |
| `hygiene_delta_or_safe_block_or_clean_state` | 8 | 8 | 0 |
| `recovery_safe_blocked_weak_target` | 1 | 3 | +2 |
...
| `recovery_target_gate_weak_target_turns` | 1 | 3 | +2 |
| `recovery_target_gate_fallback_target_turns` | 1 | 2 | +1 |
| `recovery_target_gate_empty_target_turns` | 0 | 0 | 0 |
| `recovery_patch_operation_reject_patch_turns` | 2 | 7 | +5 |
...
| code | GUARDED1000 | TERMINAL_2324 | delta | interpreted safety outcome |
|---|---|---|---|---|
| `BLOCKED_BY_POLICY` | 2 | 6 | +4 | **safe_blocked_patch (policy restriction/abstention)** |
| `INSUFFICIENT_EVIDENCE` | 0 | 1 | +1 | **safe_blocked_patch (insufficient evidence criteria)** |
| `SUCCESS` | 2 | 1 | -1 | **recovery_patch_committed** |

## Final decision distribution

| decision | GUARDED1000 | TERMINAL_2324 |
|---|---|---|
| `accept` | 5 | 3 |
| `reject` | 3 | 5 |
