...
| `recovery_safe_resolution_or_clean_state` | `>=` | 20 |  | 39 | PASS |
| `hygiene_delta_or_safe_block_or_clean_state` | `>=` | 20 |  | 39 | PASS |
| `real_strong_support_total` | `>=` | 30 |  | 198 | PASS |
| `independent_support_group_total` | `>=` | 24 |  | 198 | PASS |
| `empirical_real_strong_support_count` | `>=` | 20 |  | 143 | PASS |
| `claims_with_deep_support` | `>=` | 8 |  | 102 | PASS |
...
| `programmatic_specific_locator_count` | `>=` | 18 |  | 114 | PASS |
...
| `payload_evidence_item_total` | 379 |
| `evidence_agent_nonempty_payload_turns` | 241 |
| `evidence_agent_question_only_turns` | 25 |
| `first_support_fallback_turns` | 22 |
| `model_adapter_quote_first_rewrite_count` | 0 |
| `model_adapter_strength_downgrade_count` | 0 |
| `small_model_quote_bank_augmentation_count` | 176 |
...
| `diagnostic_independent_support_group_total` | 199 |
| `claims_with_2plus_independent_or_diagnostic_support` | 94 |
| `empirical_real_strong_support_count` | 143 |
| `method_real_strong_support_count` | 50 |
| `table_or_figure_real_strong_support_count` | 84 |
| `result_or_experiment_real_strong_support_count` | 57 |
| `ablation_real_strong_support_count` | 7 |
| `abstract_real_strong_support_count` | 0 |
| `verified_moderate_support_total` | 1 |
| `moderate_diagnostic_support_total` | 1 |
| `moderate_absorbed_into_final_strong_count` | 96 |
| `moderate_remaining_diagnostic_count` | 1 |
| `diagnostic_support_signal_total` | 199 |
| `papers_with_real_strong_support` | 39 |
| `papers_with_empirical_support` | 38 |
| `papers_with_deep_support` | 39 |
| `positive_coverage_gap_papers` | 0 |
| `empirical_coverage_gap_papers` | 1 |
| `deep_support_gap_papers` | 0 |
| `claims_with_real_strong_support` | 104 |
| `claims_with_empirical_real_strong_support` | 89 |
| `claims_with_deep_support` | 102 |
| `claims_with_2plus_independent_support` | 93 |
| `primary_claim_total` | 116 |
| `primary_claims_with_real_strong_support` | 96 |
| `primary_claims_with_empirical_support` | 82 |
| `primary_claims_with_deep_support` | 94 |
| `zero_real_papers` | 0 |
| `final_support_total` | 198 |
| `final_support_direct_strong_count` | 102 |
| `final_support_promoted_from_medium_count` | 96 |
...
| `negative_type_negative_result` | 4 |
...
| `verified_potential_concern_count` | 9 |
...
| `diagnostic_targeted_open_gap_count` | 6 |
| `targeted_open_gap_count` | 6 |
| `assessment_limitation_open_gap_count` | 0 |
| `unresolved_open_count` | 0 |
| `unresolved_open_raw_count` | 114 |
| `unresolved_resolved_count` | 0 |
| `unresolved_deferred_count` | 114 |
| `targetless_unresolved_deferred_count` | 0 |
| `programmatic_specific_locator_count` | 114 |
| `programmatic_weak_locator_count` | 84 |
| `programmatic_locator_type_table_count` | 30 |
| `programmatic_locator_type_figure_count` | 34 |
| `programmatic_locator_type_section_count` | 45 |
| `programmatic_locator_type_algorithm_count` | 3 |
| `programmatic_locator_type_theorem_count` | 2 |
| `programmatic_locator_type_generic_count` | 84 |
| `programmatic_high_confidence_locator_count` | 114 |
...
| `recovery_patch_committed` | 24 |
| `recovery_committed` | 24 |
| `recovery_success` | 24 |
| `hygiene_delta_improved` | 8 |
| `recovery_effective_repair` | 8 |
| `recovery_no_effect_commit` | 0 |
| `recovery_harmful_commit_risk` | 1 |
| `recovery_safe_resolution` | 33 |
| `recovery_safe_resolution_or_clean_state` | 39 |
| `hygiene_delta_or_safe_block` | 17 |
| `hygiene_delta_or_safe_block_or_clean_state` | 39 |
| `recovery_safe_blocked_weak_target` | 2 |
| `recovery_safe_blocked_terminal_target` | 7 |
| `recovery_terminal_turns` | 7 |
| `recovery_repeat_allowed_false_turns` | 7 |
| `recovery_target_gate_real_target_turns` | 3 |
| `recovery_target_gate_negative_verified_target_turns` | 28 |
...
| `recovery_patch_operation_mark_contested_turns` | 22 |
...
| `SUCCESS` | 24 | **recovery_patch_committed** |
