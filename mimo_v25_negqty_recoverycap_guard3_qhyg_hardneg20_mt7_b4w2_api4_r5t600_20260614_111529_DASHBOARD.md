...
- candidate: `mimo_v25_negqty_recoverycap_guard3_qhyg_hardneg20_mt7_b4w2_api4_r5t600_20260614_111529.jsonl` (label: mimo_v25_negqty_recoverycap_guard3_qhyg_hardneg20_mt7_b4w2_api4_r5t600_20260614_111529, papers: 20)
...
| `real_strong_support_total` | `>=` | 16 | smoke scaled from 30/39 | 102 | PASS |
| `independent_support_group_total` | `>=` | 13 | smoke scaled from 24/39 | 102 | PASS |
| `empirical_real_strong_support_count` | `>=` | 11 | smoke scaled from 20/39 | 82 | PASS |
| `claims_with_deep_support` | `>=` | 5 | smoke scaled from 8/39 | 50 | PASS |
...
| `programmatic_specific_locator_count` | `>=` | 10 | smoke scaled from 18/39 | 74 | PASS |

**Overall protection: PASS**

## Evidence formation health

| metric | mimo_v25_negqty_recoverycap_guard3_qhyg_hardneg20_mt7_b4w2_api4_r5t600_20260614_111529 |
|---|---|
| `evidence_agent_worker_turns` | 107 |
| `quote_bank_nonzero_turns` | 107 |
| `payload_evidence_item_total` | 134 |
| `evidence_agent_nonempty_payload_turns` | 106 |
| `evidence_agent_question_only_turns` | 30 |
| `first_support_fallback_turns` | 35 |
| `model_adapter_quote_first_rewrite_count` | 0 |
| `model_adapter_strength_downgrade_count` | 0 |
| `small_model_quote_bank_augmentation_count` | 68 |
...
| metric | mimo_v25_negqty_recoverycap_guard3_qhyg_hardneg20_mt7_b4w2_api4_r5t600_20260614_111529 |
|---|---|
| `real_strong_support_total` | 102 |
| `independent_support_group_total` | 102 |
| `diagnostic_independent_support_group_total` | 104 |
| `claims_with_2plus_independent_or_diagnostic_support` | 51 |
| `empirical_real_strong_support_count` | 82 |
| `method_real_strong_support_count` | 20 |
| `table_or_figure_real_strong_support_count` | 57 |
| `result_or_experiment_real_strong_support_count` | 21 |
...
| `moderate_absorbed_into_final_strong_count` | 65 |
| `moderate_remaining_diagnostic_count` | 2 |
| `diagnostic_support_signal_total` | 104 |
...
| `claims_with_deep_support` | 50 |
| `claims_with_2plus_independent_support` | 50 |
| `primary_claim_total` | 59 |
| `primary_claims_with_real_strong_support` | 47 |
| `primary_claims_with_empirical_support` | 45 |
| `primary_claims_with_deep_support` | 45 |
| `zero_real_papers` | 0 |
| `final_support_total` | 102 |
| `final_support_direct_strong_count` | 37 |
| `final_support_promoted_from_medium_count` | 65 |
...
| `support_trace_included_count` | 102 |
...
| `final_support_specific_locator_count` | 74 |
| `final_support_weak_locator_count` | 28 |
...
| `negative_type_negative_result` | 5 |
...
| `assessment_limitation_flaw_count` | 7 |
...
| `contested_final_support_total` | 16 |
| `claims_with_contested_support` | 8 |
| `claims_with_contested_final_support` | 8 |
...
| `negative_verified_target_preserved_count` | 15 |
...
| `evidence_gap_not_assessable_count` | 19 |
...
| `unresolved_open_raw_count` | 58 |
| `unresolved_resolved_count` | 0 |
| `unresolved_deferred_count` | 58 |
| `targetless_unresolved_deferred_count` | 0 |
| `programmatic_specific_locator_count` | 74 |
| `programmatic_weak_locator_count` | 28 |
| `programmatic_locator_type_table_count` | 26 |
| `programmatic_locator_type_figure_count` | 21 |
| `programmatic_locator_type_section_count` | 25 |
| `programmatic_locator_type_algorithm_count` | 2 |
| `programmatic_locator_type_theorem_count` | 0 |
| `programmatic_locator_type_generic_count` | 28 |
| `programmatic_high_confidence_locator_count` | 73 |
...
| metric | mimo_v25_negqty_recoverycap_guard3_qhyg_hardneg20_mt7_b4w2_api4_r5t600_20260614_111529 |
|---|---|
| `recovery_attempted` | 17 |
| `recovery_patch_validated` | 9 |
...
| code | mimo_v25_negqty_recoverycap_guard3_qhyg_hardneg20_mt7_b4w2_api4_r5t600_20260614_111529 | interpreted safety outcome |
|---|---|---|
...
| decision | mimo_v25_negqty_recoverycap_guard3_qhyg_hardneg20_mt7_b4w2_api4_r5t600_20260614_111529 |
|---|---|
| `accept` | 15 |
| `reject` | 5 |
