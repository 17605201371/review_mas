...
- candidate: `mimo_v25_negqty_recoverycap_guard3_qhyg_targetneg_freeformrevneg_reviewissuebundle_hardneg20_mt7_b4w2_api2_r8t600_tok1536_20260627_101215.jsonl` (label: STRUCTEXPECT2_RECOMPUTE, papers: 20)
...
| metric | PREV_090139 | STRUCTEXPECT2_RECOMPUTE | delta |
|---|---|---|---|
...
| `negative_evidence_candidate_raw_count` | 6 | 9 | +3 |
| `review_negative_verified_count` | 0 | 0 | 0 |
| `reviewer_absence_verified_count` | 6 | 8 | +2 |
| `reviewer_absence_verified_claim_count` | 5 | 8 | +3 |
| `reviewer_absence_verified_flaw_count` | 5 | 8 | +3 |
| `total_review_negative_verified_count` | 6 | 8 | +2 |
| `quote_grounded_review_issue_count` | 0 | 0 | 0 |
| `obligation_grounded_review_issue_count` | 6 | 8 | +2 |
| `obligation_grounded_review_issue_claim_count` | 5 | 8 | +3 |
| `verified_review_issue_count` | 6 | 8 | +2 |
| `verified_review_issue_claim_count` | 5 | 8 | +3 |
| `review_issue_bundle_count` | 6 | 8 | +2 |
| `review_issue_type_missing_ablation` | 2 | 2 | 0 |
| `review_issue_type_missing_baseline` | 1 | 1 | 0 |
| `review_issue_type_unfair_or_weak_baseline` | 1 | 0 | -1 |
| `review_issue_type_insufficient_evaluation` | 0 | 3 | +3 |
...
| `negative_evidence_linked_to_flaw_raw_count` | 6 | 9 | +3 |
| `negative_evidence_unlinked_to_flaw` | 0 | 0 | 0 |
| `verified_negative_flaw_count` | 5 | 10 | +5 |
| `verified_actionable_negative_flaw_count` | 5 | 10 | +5 |
| `verified_limitation_negative_flaw_count` | 0 | 0 | 0 |
| `negative_type_direct_contradiction` | 0 | 0 | 0 |
| `negative_type_negative_result` | 0 | 0 | 0 |
| `negative_type_missing_ablation` | 3 | 2 | -1 |
| `negative_type_missing_baseline` | 1 | 2 | +1 |
| `negative_type_unfair_or_weak_baseline` | 1 | 0 | -1 |
| `negative_type_insufficient_evaluation` | 0 | 3 | +3 |
...
| `verified_potential_concern_count` | 5 | 10 | +5 |
| `grounded_weakness_count` | 0 | 0 | 0 |
| `assessment_limitation_flaw_count` | 16 | 10 | -6 |
| `negative_grounding_conflict_count` | 4 | 3 | -1 |
| `invalid_negative_evidence_id_count_legacy` | 4 | 3 | -1 |
| `negative_semantic_anchor_conflict_count` | 4 | 3 | -1 |
| `generic_gap_semantic_rejected_count` | 0 | 0 | 0 |
| `negative_evidence_semantic_rejected_count` | 1 | 2 | +1 |
| `downgraded_flaw_count` | 1 | 2 | +1 |
| `potential_concern_count` | 5 | 10 | +5 |
...
| `final_potential_concern_total` | 19 | 28 | +9 |
...
| metric | PREV_090139 | STRUCTEXPECT2_RECOMPUTE | delta |
|---|---|---|---|
| `state_contamination_count` | 8 | 10 | +2 |
| `state_contamination_count_legacy` | 8 | 10 | +2 |
| `harmful_state_contamination_count` | 0 | 0 | 0 |
| `repairable_state_warning_count` | 0 | 0 | 0 |
| `conservative_state_warning_count` | 8 | 10 | +2 |
| `state_hygiene_warning_count` | 8 | 10 | +2 |
| `weak_target_warning_count` | 8 | 10 | +2 |
| `repairable_contamination_target_count` | 0 | 0 | 0 |
| `conservative_contamination_target_count` | 8 | 10 | +2 |
...
| `target_gate_weak_target` | 8 | 10 | +2 |
...
| metric | PREV_090139 | STRUCTEXPECT2_RECOMPUTE | delta |
|---|---|---|---|
| `contested_support_total` | 5 | 6 | +1 |
| `contested_final_support_total` | 2 | 4 | +2 |
| `claims_with_contested_support` | 3 | 2 | -1 |
| `claims_with_contested_final_support` | 2 | 2 | 0 |
...
| `state_hygiene_open_gap_count` | 13 | 14 | +1 |
| `state_hygiene_stale_gap_count` | 2 | 7 | +5 |
...
| `recovery_case_verified_review_issue_repair` | 0 | 2 | +2 |
...
| `recovery_case_effective_repair_without_verified_negative` | 0 | 1 | +1 |
...
| `recovery_case_turns_with_verified_review_issue_bundle_evidence` | 2 | 2 | 0 |
...
| `recovery_case_evidence_bucket_obligation_grounded_review_issue` | 2 | 2 | 0 |
...
| code | PREV_090139 | STRUCTEXPECT2_RECOMPUTE | delta | interpreted safety outcome |
|---|---|---|---|---|
...
| decision | PREV_090139 | STRUCTEXPECT2_RECOMPUTE |
|---|---|---|
| `reject` | 20 | 20 |
