...
- candidate: `mimo_v25_negqty_recoverycap_guard3_qhyg_targetneg_freeformrevneg_reviewissuebundle_hardneg20_mt7_b4w2_api2_r8t600_tok1536_20260627_113021.jsonl` (label: CANDKEY2_RECOMPUTE, papers: 20)
...
| metric | STRUCTEXPECT2_101215 | CANDKEY2_RECOMPUTE | delta |
|---|---|---|---|
...
| metric | STRUCTEXPECT2_101215 | CANDKEY2_RECOMPUTE | delta |
|---|---|---|---|
| `negative_evidence_candidate_count` | 6 | 8 | +2 |
| `negative_evidence_candidate_raw_count` | 13 | 12 | -1 |
| `review_negative_verified_count` | 0 | 1 | +1 |
| `reviewer_absence_verified_count` | 6 | 7 | +1 |
| `reviewer_absence_verified_claim_count` | 6 | 12 | +6 |
| `reviewer_absence_verified_flaw_count` | 11 | 10 | -1 |
| `total_review_negative_verified_count` | 6 | 8 | +2 |
| `quote_grounded_review_issue_count` | 0 | 1 | +1 |
| `obligation_grounded_review_issue_count` | 6 | 7 | +1 |
| `obligation_grounded_review_issue_claim_count` | 6 | 7 | +1 |
| `reviewer_candidate_review_issue_count` | 5 | 4 | -1 |
| `reviewer_candidate_review_issue_claim_count` | 5 | 4 | -1 |
| `claim_obligation_review_issue_count` | 1 | 3 | +2 |
| `claim_obligation_review_issue_claim_count` | 1 | 3 | +2 |
| `verified_review_issue_count` | 6 | 8 | +2 |
| `verified_review_issue_claim_count` | 6 | 8 | +2 |
| `review_issue_bundle_count` | 6 | 7 | +1 |
...
| `review_issue_type_insufficient_evaluation` | 1 | 1 | 0 |
...
| `negative_evidence_linked_to_flaw_count` | 6 | 8 | +2 |
| `negative_evidence_linked_to_flaw_raw_count` | 13 | 12 | -1 |
| `negative_evidence_unlinked_to_flaw` | 0 | 0 | 0 |
| `verified_negative_flaw_count` | 13 | 12 | -1 |
| `verified_actionable_negative_flaw_count` | 13 | 12 | -1 |
...
| `negative_type_missing_baseline` | 3 | 0 | -3 |
| `negative_type_unfair_or_weak_baseline` | 0 | 0 | 0 |
| `negative_type_insufficient_evaluation` | 2 | 1 | -1 |
| `negative_type_missing_robustness_or_generalization` | 0 | 0 | 0 |
| `negative_type_evaluation_protocol_risk` | 0 | 1 | +1 |
| `negative_type_efficiency_cost_gap` | 2 | 4 | +2 |
| `negative_type_reproducibility_gap` | 0 | 2 | +2 |
...
| `verified_potential_concern_count` | 13 | 12 | -1 |
| `grounded_weakness_count` | 0 | 0 | 0 |
| `assessment_limitation_flaw_count` | 10 | 29 | +19 |
| `negative_grounding_conflict_count` | 3 | 14 | +11 |
| `invalid_negative_evidence_id_count_legacy` | 3 | 14 | +11 |
| `negative_semantic_anchor_conflict_count` | 3 | 14 | +11 |
| `generic_gap_semantic_rejected_count` | 0 | 0 | 0 |
| `negative_evidence_semantic_rejected_count` | 2 | 1 | -1 |
| `downgraded_flaw_count` | 2 | 5 | +3 |
| `potential_concern_count` | 13 | 12 | -1 |
...
| `final_potential_concern_total` | 33 | 28 | -5 |
...
| metric | STRUCTEXPECT2_101215 | CANDKEY2_RECOMPUTE | delta |
|---|---|---|---|
| `state_contamination_count` | 8 | 17 | +9 |
| `state_contamination_count_legacy` | 8 | 17 | +9 |
| `harmful_state_contamination_count` | 0 | 0 | 0 |
| `repairable_state_warning_count` | 0 | 0 | 0 |
| `conservative_state_warning_count` | 8 | 17 | +9 |
| `state_hygiene_warning_count` | 8 | 17 | +9 |
| `weak_target_warning_count` | 8 | 17 | +9 |
| `repairable_contamination_target_count` | 0 | 0 | 0 |
| `conservative_contamination_target_count` | 8 | 17 | +9 |
...
| `target_gate_weak_target` | 8 | 17 | +9 |
...
| `contested_final_support_total` | 4 | 10 | +6 |
...
| `state_hygiene_open_gap_count` | 16 | 13 | -3 |
| `state_hygiene_stale_gap_count` | 5 | 4 | -1 |
...
| `recovery_case_verified_review_issue_repair` | 2 | 4 | +2 |
...
| `recovery_case_effective_repair_without_verified_negative` | 1 | 5 | +4 |
...
| `recovery_case_turns_with_verified_review_issue_bundle_evidence` | 2 | 5 | +3 |
...
| `recovery_case_evidence_bucket_obligation_grounded_review_issue` | 2 | 5 | +3 |
...
| code | STRUCTEXPECT2_101215 | CANDKEY2_RECOMPUTE | delta | interpreted safety outcome |
|---|---|---|---|---|
...
| decision | STRUCTEXPECT2_101215 | CANDKEY2_RECOMPUTE |
|---|---|---|
| `reject` | 20 | 20 |
