...
- candidate: `mimo_v25_negqty_recoverycap_guard3_qhyg_targetneg_freeformrevneg_reviewissuebundle_hardneg20_mt7_b4w2_api2_r8t600_tok1536_20260627_113021.jsonl` (label: ISSUEDISC1_RECOMPUTE, papers: 20)
...
| metric | STRUCTEXPECT2_101215 | ISSUEDISC1_RECOMPUTE | delta |
|---|---|---|---|
...
| `negative_evidence_linked_to_flaw_raw_count` | 9 | 12 | +3 |
| `negative_evidence_unlinked_to_flaw` | 0 | 0 | 0 |
| `verified_negative_flaw_count` | 10 | 12 | +2 |
| `verified_actionable_negative_flaw_count` | 10 | 12 | +2 |
...
| `negative_type_efficiency_cost_gap` | 1 | 4 | +3 |
...
| `verified_potential_concern_count` | 10 | 12 | +2 |
...
| `potential_concern_count` | 10 | 12 | +2 |
...
| `final_potential_concern_total` | 30 | 28 | -2 |
...
| code | STRUCTEXPECT2_101215 | ISSUEDISC1_RECOMPUTE | delta | interpreted safety outcome |
|---|---|---|---|---|
...
| decision | STRUCTEXPECT2_101215 | ISSUEDISC1_RECOMPUTE |
|---|---|---|
| `reject` | 20 | 20 |
