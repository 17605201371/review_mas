...
| 7Dub7UXTXN | 6 | verified_review_issue_repair | mark_contested | hygiene_delta_improved | claim:claim-3 | supported->supported | {"obligation_grounded_review_issue": 1} |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 7Dub7UXTXN | 6 | verified_review_issue_repair | evidence-reviewer-absence-claim-3-baseline-or-comparison | obligation_grounded_review_issue | missing_baseline | review_negative_absence_audit_verified | Results / Evaluation excerpt #1 | missing/mismatch: same-setting baseline or comparison for the claimed improvement; observed inventory: Our symmetry condition on the dataset incorporates several previous results as special cases \citep{sarussi21linteacher,lyu21maxmargin}. |
