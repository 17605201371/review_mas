...
- candidate: `mimo_v25_negqty_recoverycap_guard3_qhyg_targetneg_freeformrevneg_reviewissuebundle_hardneg20_mt7_b4w2_api2_r8t600_tok1536_20260627_113021.jsonl` (label: SURFACEHINT1_BINDINGFIX1_RECOMPUTE, papers: 20)
...
| metric | STRUCTEXPECT2_101215 | SURFACEHINT1_BINDINGFIX1_RECOMPUTE | delta |
|---|---|---|---|
...
| metric | STRUCTEXPECT2_101215 | SURFACEHINT1_BINDINGFIX1_RECOMPUTE | delta |
|---|---|---|---|
| `negative_evidence_candidate_count` | 8 | 10 | +2 |
| `negative_evidence_candidate_raw_count` | 9 | 10 | +1 |
| `review_negative_verified_count` | 0 | 2 | +2 |
| `reviewer_absence_verified_count` | 8 | 8 | 0 |
| `reviewer_absence_verified_claim_count` | 8 | 8 | 0 |
| `reviewer_absence_verified_flaw_count` | 8 | 8 | 0 |
| `total_review_negative_verified_count` | 8 | 10 | +2 |
| `quote_grounded_review_issue_count` | 0 | 2 | +2 |
| `obligation_grounded_review_issue_count` | 8 | 8 | 0 |
| `obligation_grounded_review_issue_claim_count` | 8 | 8 | 0 |
| `verified_review_issue_count` | 8 | 10 | +2 |
| `verified_review_issue_claim_count` | 8 | 9 | +1 |
| `review_issue_bundle_count` | 8 | 8 | 0 |
| `review_issue_type_missing_ablation` | 2 | 1 | -1 |
| `review_issue_type_missing_baseline` | 1 | 1 | 0 |
| `review_issue_type_unfair_or_weak_baseline` | 0 | 0 | 0 |
| `review_issue_type_insufficient_evaluation` | 3 | 2 | -1 |
...
| `paper_text_negative_candidate_count` | 8 | 23 | +15 |
...
| `negative_evidence_linked_to_flaw_count` | 8 | 10 | +2 |
| `negative_evidence_linked_to_flaw_raw_count` | 9 | 10 | +1 |
| `negative_evidence_unlinked_to_flaw` | 0 | 0 | 0 |
| `verified_negative_flaw_count` | 10 | 11 | +1 |
| `verified_actionable_negative_flaw_count` | 10 | 11 | +1 |
| `verified_limitation_negative_flaw_count` | 0 | 0 | 0 |
| `negative_type_direct_contradiction` | 0 | 0 | 0 |
| `negative_type_negative_result` | 0 | 2 | +2 |
| `negative_type_missing_ablation` | 2 | 1 | -1 |
| `negative_type_missing_baseline` | 2 | 1 | -1 |
| `negative_type_unfair_or_weak_baseline` | 0 | 0 | 0 |
| `negative_type_insufficient_evaluation` | 3 | 3 | 0 |
...
| `verified_potential_concern_count` | 10 | 11 | +1 |
| `grounded_weakness_count` | 0 | 0 | 0 |
| `assessment_limitation_flaw_count` | 10 | 25 | +15 |
| `negative_grounding_conflict_count` | 3 | 11 | +8 |
| `invalid_negative_evidence_id_count_legacy` | 3 | 11 | +8 |
| `negative_semantic_anchor_conflict_count` | 3 | 11 | +8 |
| `generic_gap_semantic_rejected_count` | 0 | 0 | 0 |
| `negative_evidence_semantic_rejected_count` | 2 | 1 | -1 |
| `downgraded_flaw_count` | 2 | 4 | +2 |
| `potential_concern_count` | 10 | 11 | +1 |
...
| `final_potential_concern_total` | 28 | 29 | +1 |
...
| metric | STRUCTEXPECT2_101215 | SURFACEHINT1_BINDINGFIX1_RECOMPUTE | delta |
|---|---|---|---|
| `state_contamination_count` | 10 | 15 | +5 |
| `state_contamination_count_legacy` | 10 | 15 | +5 |
| `harmful_state_contamination_count` | 0 | 0 | 0 |
| `repairable_state_warning_count` | 0 | 0 | 0 |
| `conservative_state_warning_count` | 10 | 15 | +5 |
| `state_hygiene_warning_count` | 10 | 15 | +5 |
| `weak_target_warning_count` | 10 | 15 | +5 |
| `repairable_contamination_target_count` | 0 | 0 | 0 |
| `conservative_contamination_target_count` | 10 | 15 | +5 |
...
| `target_gate_weak_target` | 10 | 15 | +5 |
...
| `contested_final_support_total` | 4 | 8 | +4 |
...
| `state_hygiene_open_gap_count` | 14 | 12 | -2 |
| `state_hygiene_stale_gap_count` | 7 | 5 | -2 |
...
| `recovery_case_verified_review_issue_repair` | 2 | 6 | +4 |
...
| `recovery_case_effective_repair_without_verified_negative` | 1 | 3 | +2 |
...
| `recovery_case_turns_with_verified_review_issue_bundle_evidence` | 2 | 7 | +5 |
...
| `recovery_case_evidence_bucket_obligation_grounded_review_issue` | 2 | 7 | +5 |
...
| code | STRUCTEXPECT2_101215 | SURFACEHINT1_BINDINGFIX1_RECOMPUTE | delta | interpreted safety outcome |
|---|---|---|---|---|
...
| decision | STRUCTEXPECT2_101215 | SURFACEHINT1_BINDINGFIX1_RECOMPUTE |
|---|---|---|
| `reject` | 20 | 20 |
