...
- candidate: `mimo_v25_negqty_recoverycap_guard3_qhyg_targetneg_freeformrevneg_reviewissuebundle_hardneg20_mt7_b4w2_api2_r8t600_tok1536_20260627_113021.jsonl` (label: SURFACEHINT1_QUALITYFIX2_RECOMPUTE, papers: 20)
...
| metric | STRUCTEXPECT2_101215 | SURFACEHINT1_QUALITYFIX2_RECOMPUTE | delta |
|---|---|---|---|
...
| metric | STRUCTEXPECT2_101215 | SURFACEHINT1_QUALITYFIX2_RECOMPUTE | delta |
|---|---|---|---|
| `negative_evidence_candidate_count` | 8 | 7 | -1 |
| `negative_evidence_candidate_raw_count` | 9 | 8 | -1 |
| `review_negative_verified_count` | 0 | 1 | +1 |
| `reviewer_absence_verified_count` | 8 | 6 | -2 |
| `reviewer_absence_verified_claim_count` | 8 | 9 | +1 |
| `reviewer_absence_verified_flaw_count` | 8 | 6 | -2 |
| `total_review_negative_verified_count` | 8 | 7 | -1 |
| `quote_grounded_review_issue_count` | 0 | 1 | +1 |
| `obligation_grounded_review_issue_count` | 8 | 6 | -2 |
| `obligation_grounded_review_issue_claim_count` | 8 | 6 | -2 |
| `verified_review_issue_count` | 8 | 7 | -1 |
| `verified_review_issue_claim_count` | 8 | 7 | -1 |
| `review_issue_bundle_count` | 8 | 6 | -2 |
...
| `negative_evidence_linked_to_flaw_count` | 8 | 7 | -1 |
| `negative_evidence_linked_to_flaw_raw_count` | 9 | 8 | -1 |
| `negative_evidence_unlinked_to_flaw` | 0 | 0 | 0 |
| `verified_negative_flaw_count` | 10 | 9 | -1 |
| `verified_actionable_negative_flaw_count` | 10 | 9 | -1 |
...
| `verified_potential_concern_count` | 10 | 9 | -1 |
...
| `potential_concern_count` | 10 | 9 | -1 |
...
| `final_potential_concern_total` | 28 | 26 | -2 |
...
| metric | STRUCTEXPECT2_101215 | SURFACEHINT1_QUALITYFIX2_RECOMPUTE | delta |
|---|---|---|---|
| `contested_support_total` | 6 | 16 | +10 |
| `contested_final_support_total` | 4 | 7 | +3 |
| `claims_with_contested_support` | 2 | 5 | +3 |
| `claims_with_contested_final_support` | 2 | 5 | +3 |
...
| code | STRUCTEXPECT2_101215 | SURFACEHINT1_QUALITYFIX2_RECOMPUTE | delta | interpreted safety outcome |
|---|---|---|---|---|
...
| decision | STRUCTEXPECT2_101215 | SURFACEHINT1_QUALITYFIX2_RECOMPUTE |
|---|---|---|
| `reject` | 20 | 20 |
