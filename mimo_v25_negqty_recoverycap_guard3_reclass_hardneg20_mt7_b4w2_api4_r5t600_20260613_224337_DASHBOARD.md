...
- candidate: `mimo_v25_negqty_recoverycap_guard3_reclass_hardneg20_mt7_b4w2_api4_r5t600_20260613_224337.jsonl` (label: mimo_v25_negqty_recoverycap_guard3_reclass_hardneg20_mt7_b4w2_api4_r5t600_20260613_224337, papers: 20)
...
| `real_strong_support_total` | `>=` | 16 | smoke scaled from 30/39 | 92 | PASS |
| `independent_support_group_total` | `>=` | 13 | smoke scaled from 24/39 | 92 | PASS |
| `empirical_real_strong_support_count` | `>=` | 11 | smoke scaled from 20/39 | 71 | PASS |
| `claims_with_deep_support` | `>=` | 5 | smoke scaled from 8/39 | 47 | PASS |
...
| metric | mimo_v25_negqty_recoverycap_guard3_reclass_hardneg20_mt7_b4w2_api4_r5t600_20260613_224337 |
|---|---|
| `evidence_agent_worker_turns` | 106 |
| `quote_bank_nonzero_turns` | 106 |
| `payload_evidence_item_total` | 117 |
| `evidence_agent_nonempty_payload_turns` | 105 |
| `evidence_agent_question_only_turns` | 38 |
| `first_support_fallback_turns` | 38 |
| `model_adapter_quote_first_rewrite_count` | 0 |
| `model_adapter_strength_downgrade_count` | 0 |
| `small_model_quote_bank_augmentation_count` | 55 |
...
| metric | mimo_v25_negqty_recoverycap_guard3_reclass_hardneg20_mt7_b4w2_api4_r5t600_20260613_224337 |
|---|---|
| `real_strong_support_total` | 92 |
| `independent_support_group_total` | 92 |
| `diagnostic_independent_support_group_total` | 92 |
| `claims_with_2plus_independent_or_diagnostic_support` | 45 |
| `empirical_real_strong_support_count` | 71 |
| `method_real_strong_support_count` | 19 |
| `table_or_figure_real_strong_support_count` | 54 |
| `result_or_experiment_real_strong_support_count` | 14 |
| `ablation_real_strong_support_count` | 4 |
| `abstract_real_strong_support_count` | 1 |
| `verified_moderate_support_total` | 0 |
| `moderate_diagnostic_support_total` | 0 |
| `moderate_absorbed_into_final_strong_count` | 63 |
| `moderate_remaining_diagnostic_count` | 0 |
| `diagnostic_support_signal_total` | 92 |
...
| `claims_with_empirical_real_strong_support` | 47 |
| `claims_with_deep_support` | 47 |
| `claims_with_2plus_independent_support` | 45 |
| `primary_claim_total` | 60 |
| `primary_claims_with_real_strong_support` | 41 |
| `primary_claims_with_empirical_support` | 41 |
| `primary_claims_with_deep_support` | 41 |
| `zero_real_papers` | 0 |
| `final_support_total` | 92 |
| `final_support_direct_strong_count` | 29 |
| `final_support_promoted_from_medium_count` | 63 |
...
| `support_trace_total` | 92 |
| `support_trace_included_count` | 92 |
...
| `verified_negative_flaw_count` | 14 |
| `verified_actionable_negative_flaw_count` | 8 |
| `verified_limitation_negative_flaw_count` | 6 |
...
| `evidence_gap_resolved_count` | 47 |
| `evidence_gap_superseded_count` | 0 |
| `evidence_gap_not_assessable_count` | 20 |
...
| `unresolved_open_raw_count` | 56 |
| `unresolved_resolved_count` | 0 |
| `unresolved_deferred_count` | 56 |
| `targetless_unresolved_deferred_count` | 0 |
| `programmatic_specific_locator_count` | 70 |
| `programmatic_weak_locator_count` | 22 |
| `programmatic_locator_type_table_count` | 19 |
| `programmatic_locator_type_figure_count` | 26 |
...
| `programmatic_high_confidence_locator_count` | 69 |
...
| code | mimo_v25_negqty_recoverycap_guard3_reclass_hardneg20_mt7_b4w2_api4_r5t600_20260613_224337 | interpreted safety outcome |
|---|---|---|
...
| decision | mimo_v25_negqty_recoverycap_guard3_reclass_hardneg20_mt7_b4w2_api4_r5t600_20260613_224337 |
|---|---|
| `accept` | 10 |
| `reject` | 10 |
