...
- candidate: `mimo_v25_rerun_latest_mt7_smoke8_b4w4_api1_20260607_1021.jsonl` (label: MIMO_RERUN_LATEST_MT7_SMOKE8, papers: 8)
- baseline:  `mimo_v25_gapresolved_mt7_smoke8_20260606.jsonl` (label: MIMO_GAPRESOLVED_MT7_SMOKE8, papers: 8)
...
| metric | MIMO_GAPRESOLVED_MT7_SMOKE8 | MIMO_RERUN_LATEST_MT7_SMOKE8 | delta |
|---|---|---|---|
| `evidence_agent_worker_turns` | 45 | 46 | +1 |
| `quote_bank_nonzero_turns` | 45 | 45 | 0 |
| `payload_evidence_item_total` | 59 | 54 | -5 |
| `evidence_agent_nonempty_payload_turns` | 35 | 30 | -5 |
| `evidence_agent_question_only_turns` | 0 | 3 | +3 |
| `first_support_fallback_turns` | 4 | 2 | -2 |
| `model_adapter_quote_first_rewrite_count` | 0 | 0 | 0 |
| `model_adapter_strength_downgrade_count` | 0 | 0 | 0 |
| `small_model_quote_bank_augmentation_count` | 27 | 28 | +1 |
...
| metric | MIMO_GAPRESOLVED_MT7_SMOKE8 | MIMO_RERUN_LATEST_MT7_SMOKE8 | delta |
|---|---|---|---|
| `real_strong_support_total` | 33 | 30 | -3 |
...
| `empirical_real_strong_support_count` | 21 | 20 | -1 |
| `method_real_strong_support_count` | 12 | 10 | -2 |
...
| `moderate_absorbed_into_final_strong_count` | 18 | 17 | -1 |
| `moderate_remaining_diagnostic_count` | 0 | 0 | 0 |
| `diagnostic_support_signal_total` | 33 | 30 | -3 |
...
| `claims_with_empirical_real_strong_support` | 12 | 13 | +1 |
...
| `primary_claims_with_empirical_support` | 12 | 13 | +1 |
| `primary_claims_with_deep_support` | 16 | 15 | -1 |
| `zero_real_papers` | 0 | 0 | 0 |
| `final_support_total` | 33 | 30 | -3 |
| `final_support_direct_strong_count` | 15 | 13 | -2 |
| `final_support_promoted_from_medium_count` | 18 | 17 | -1 |
...
| `support_trace_total` | 33 | 30 | -3 |
| `support_trace_included_count` | 33 | 30 | -3 |
...
| `final_support_weak_locator_count` | 13 | 10 | -3 |
...
| metric | MIMO_GAPRESOLVED_MT7_SMOKE8 | MIMO_RERUN_LATEST_MT7_SMOKE8 | delta |
|---|---|---|---|
| `contested_support_total` | 0 | 2 | +2 |
| `contested_final_support_total` | 0 | 2 | +2 |
| `claims_with_contested_support` | 0 | 1 | +1 |
| `claims_with_contested_final_support` | 0 | 1 | +1 |
| `open_conflict_count` | 0 | 2 | +2 |
...
| `evidence_gap_not_assessable_count` | 17 | 12 | -5 |
...
| `targetless_unresolved_deferred_count` | 1 | 5 | +4 |
| `programmatic_specific_locator_count` | 20 | 20 | 0 |
| `programmatic_weak_locator_count` | 13 | 10 | -3 |
| `programmatic_locator_type_table_count` | 4 | 3 | -1 |
| `programmatic_locator_type_figure_count` | 9 | 11 | +2 |
| `programmatic_locator_type_section_count` | 6 | 5 | -1 |
| `programmatic_locator_type_algorithm_count` | 0 | 0 | 0 |
| `programmatic_locator_type_theorem_count` | 1 | 1 | 0 |
| `programmatic_locator_type_generic_count` | 13 | 10 | -3 |
| `programmatic_high_confidence_locator_count` | 18 | 20 | +2 |
...
| `recovery_patch_validated` | 3 | 3 | 0 |
| `recovery_patch_committed` | 1 | 2 | +1 |
| `recovery_committed` | 1 | 2 | +1 |
| `recovery_success` | 1 | 2 | +1 |
...
| `recovery_safe_resolution` | 6 | 5 | -1 |
| `recovery_safe_resolution_or_clean_state` | 8 | 8 | 0 |
| `hygiene_delta_or_safe_block` | 6 | 4 | -2 |
| `hygiene_delta_or_safe_block_or_clean_state` | 8 | 8 | 0 |
| `recovery_safe_blocked_weak_target` | 5 | 3 | -2 |
| `recovery_target_gate_real_target_turns` | 1 | 2 | +1 |
| `recovery_target_gate_weak_target_turns` | 5 | 6 | +1 |
| `recovery_target_gate_fallback_target_turns` | 0 | 0 | 0 |
| `recovery_target_gate_empty_target_turns` | 1 | 1 | 0 |
| `recovery_patch_operation_reject_patch_turns` | 6 | 7 | +1 |
| `recovery_patch_operation_downgrade_final_to_candidate_turns` | 0 | 0 | 0 |
| `recovery_patch_operation_route_to_assessment_limitation_turns` | 1 | 2 | +1 |
...
| code | MIMO_GAPRESOLVED_MT7_SMOKE8 | MIMO_RERUN_LATEST_MT7_SMOKE8 | delta | interpreted safety outcome |
|---|---|---|---|---|
| `BLOCKED_BY_POLICY` | 4 | 4 | 0 | **safe_blocked_patch (policy restriction/abstention)** |
| `EVIDENCE_SEMANTIC_MISMATCH` | 2 | 0 | -2 | **safe_blocked_patch (semantic evidence validation mismatch)** |
| `EVIDENCE_TARGET_MISMATCH` | 0 | 1 | +1 | **safe_blocked_patch (missing or unverified IDs)** |
| `INVALID_STATUS_TRANSITION` | 0 | 1 | +1 | **unclassified_failure_requires_review** |
| `SUCCESS` | 1 | 2 | +1 | **recovery_patch_committed** |
| `UNKNOWN_TARGET` | 0 | 1 | +1 | **unclassified_failure_requires_review** |

## Final decision distribution

| decision | MIMO_GAPRESOLVED_MT7_SMOKE8 | MIMO_RERUN_LATEST_MT7_SMOKE8 |
|---|---|---|
| `accept` | 7 | 5 |
| `reject` | 1 | 3 |
