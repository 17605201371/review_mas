...
- candidate: `mimo_v25_tablescopefix_hardneg20_mt7_b4w2_api2_r5t600_20260622_214828.jsonl` (label: tablescopefix_hardneg20_214828, papers: 20)
...
| `semantic_negative_without_review_relation_count` | `==` | 0 |  | 1 | **FAIL** |
...
| `real_strong_support_total` | `>=` | 16 | smoke scaled from 30/39 | 76 | PASS |
| `independent_support_group_total` | `>=` | 13 | smoke scaled from 24/39 | 76 | PASS |
| `empirical_real_strong_support_count` | `>=` | 11 | smoke scaled from 20/39 | 55 | PASS |
| `claims_with_deep_support` | `>=` | 5 | smoke scaled from 8/39 | 39 | PASS |
| `support_trace_missing_verified_quote_count` | `==` | 0 |  | 3 | **FAIL** |
| `support_trace_overridden_by_negative_burden_count` | `==` | 0 |  | 0 | PASS |
| `evidence_formation_dead_loop_count` | `==` | 0 |  | 0 | PASS |
| `programmatic_specific_locator_count` | `>=` | 10 | smoke scaled from 18/39 | 54 | PASS |

**Overall protection: FAIL**

## Evidence formation health

| metric | tablescopefix_hardneg20_214828 |
|---|---|
| `evidence_agent_worker_turns` | 80 |
| `evidence_json_status_turns` | 77 |
| `evidence_json_valid_turns` | 77 |
...
| `evidence_json_raw_chars_median` | 2181 |
| `quote_bank_nonzero_turns` | 80 |
| `payload_evidence_item_total` | 134 |
| `evidence_agent_nonempty_payload_turns` | 74 |
| `evidence_agent_question_only_turns` | 22 |
...
| metric | tablescopefix_hardneg20_214828 |
|---|---|
| `real_strong_support_total` | 76 |
| `independent_support_group_total` | 76 |
| `diagnostic_independent_support_group_total` | 96 |
| `claims_with_2plus_independent_or_diagnostic_support` | 35 |
| `empirical_real_strong_support_count` | 55 |
| `method_real_strong_support_count` | 20 |
| `table_or_figure_real_strong_support_count` | 34 |
| `result_or_experiment_real_strong_support_count` | 16 |
...
| `moderate_absorbed_into_final_strong_count` | 47 |
| `moderate_remaining_diagnostic_count` | 21 |
| `diagnostic_support_signal_total` | 97 |
...
| `claims_with_real_strong_support` | 48 |
| `claims_with_empirical_real_strong_support` | 36 |
| `claims_with_deep_support` | 39 |
| `claims_with_2plus_independent_support` | 24 |
| `primary_claim_total` | 60 |
| `primary_claims_with_real_strong_support` | 45 |
| `primary_claims_with_empirical_support` | 33 |
| `primary_claims_with_deep_support` | 36 |
| `zero_real_papers` | 0 |
| `final_support_total` | 76 |
| `final_support_direct_strong_count` | 28 |
| `final_support_promoted_from_medium_count` | 47 |
| `final_support_semantic_weak_promotion_count` | 1 |
...
| `support_trace_total` | 166 |
| `support_trace_included_count` | 76 |
| `support_trace_dropped_count` | 90 |
| `support_trace_hygiene_filtered_count` | 27 |
| `support_trace_overridden_by_negative_burden_count` | 0 |
| `support_trace_weak_support_depth_count` | 29 |
| `support_trace_semantic_mismatch_count` | 23 |
| `support_trace_duplicate_quote_count` | 7 |
| `support_trace_missing_verified_quote_count` | 3 |
| `final_support_specific_locator_count` | 54 |
...
| `negative_evidence_linked_to_flaw_count` | 0 |
...
| `negative_type_generic_gap` | 2 |
| `verified_potential_concern_count` | 0 |
| `grounded_weakness_count` | 0 |
| `assessment_limitation_flaw_count` | 8 |
| `negative_grounding_conflict_count` | 2 |
| `invalid_negative_evidence_id_count_legacy` | 2 |
| `negative_semantic_anchor_conflict_count` | 2 |
| `generic_gap_semantic_rejected_count` | 2 |
| `negative_evidence_semantic_rejected_count` | 2 |
| `downgraded_flaw_count` | 2 |
| `potential_concern_count` | 0 |
| `diagnosis_pending_potential_concern_count` | 74 |
...
| `diagnosis_pending_type_insufficient_evaluation` | 22 |
| `diagnosis_pending_type_missing_robustness_or_generalization` | 1 |
| `diagnosis_pending_type_evaluation_protocol_risk` | 0 |
| `diagnosis_pending_type_efficiency_cost_gap` | 3 |
| `diagnosis_pending_type_reproducibility_gap` | 2 |
...
| metric | tablescopefix_hardneg20_214828 |
|---|---|
| `verified_coverage_gap_count` | 17 |
...
| `contamination_evidence_misbinding` | 2 |
...
| `claims_with_contested_support` | 0 |
| `claims_with_contested_final_support` | 0 |
| `open_conflict_count` | 31 |
| `contested_relation_final_count` | 0 |
| `contested_relation_added_count` | 0 |
| `contested_relation_effective_count` | 0 |
...
| `mark_contested_with_positive_support_count` | 0 |
| `mark_contested_with_verified_negative_evidence_count` | 0 |
| `mark_contested_final_view_count` | 0 |
| `contested_relation_with_positive_support_count` | 0 |
| `contested_relation_with_verified_negative_evidence_count` | 0 |
| `contested_relation_final_view_count` | 0 |

## Gap cleanup & locator

| metric | tablescopefix_hardneg20_214828 |
|---|---|
| `evidence_gap_open_count` | 14 |
| `evidence_gap_resolved_count` | 58 |
...
| `diagnostic_targeted_open_gap_count` | 14 |
| `targeted_open_gap_count` | 14 |
| `assessment_limitation_open_gap_count` | 0 |
| `unresolved_open_count` | 50 |
| `unresolved_open_raw_count` | 171 |
| `unresolved_resolved_count` | 0 |
| `unresolved_deferred_count` | 166 |
| `targetless_unresolved_deferred_count` | 0 |
| `programmatic_specific_locator_count` | 54 |
| `programmatic_weak_locator_count` | 22 |
| `programmatic_locator_type_table_count` | 16 |
...
| `programmatic_high_confidence_locator_count` | 53 |
...
| `recovery_patch_validated` | 1 |
| `recovery_patch_committed` | 0 |
| `recovery_committed` | 0 |
| `recovery_success` | 0 |
| `hygiene_delta_improved` | 0 |
| `diagnosis_pending_recorded_layer` | 0 |
| `recovery_effective_repair` | 0 |
| `recovery_no_effect_commit` | 0 |
| `recovery_harmful_commit_risk` | 0 |
| `recovery_safe_resolution` | 2 |
...
| `recovery_target_gate_real_target_turns` | 0 |
...
| `recovery_case_effective_repair_turns` | 0 |
| `recovery_case_effective_repair_not_verified_negative_repair` | 0 |
...
| code | tablescopefix_hardneg20_214828 | interpreted safety outcome |
|---|---|---|
...
| decision | tablescopefix_hardneg20_214828 |
|---|---|
| `reject` | 20 |
